...
class DeepCopy
{
     ...
     *            If set to true, when an object implements the __clone() function, it will be used
     ...
     *            Associative array with 2 members: 'filter' with value of type {@see TypeFilter} and
