...
class Matcher implements MatcherInvocation
{
    ...
    public function invoked(Invocation $invocation)
    {
        ...
        if ($this->afterMatchBuilderId !== null) {
            ...
            if (! $builder) {
                throw new RuntimeException(\sprintf('No builder found for match builder identification <%s>', $this->afterMatchBuilderId));
            }
    ...
    public function verify()
    {
        ...
        try {
            ...
            throw new ExpectationFailedException(\sprintf("Expectation failed for %s when %s.\n%s", $this->methodNameMatcher->toString(), $this->invocationMatcher->toString(), TestFailure::exceptionToString($e)));
        }
    }
