...
class MockObjectTest extends TestCase
{
    ...
    {
        $mock = $this->getMockBuilder(AnInterface::class)->getMock();
    ...
    public function testMockedMethodIsNotCalledWhenMethodSpecifiedDirectlyWithParameter()
    {
        ...
        $mock->method('doSomethingElse')->with('someArg');
    }
    ...
    {
        $mock1 = $this->getMockBuilder(AnInterface::class)->getMock();
        
        $mock2 = $this->getMockBuilder(AnInterface::class)->getMock();
    ...
    {
        $mock1 = $this->getMockBuilder(PartialMockTestClass::class)->getMock();
    ...
    public function testMockClassStoreOverrulable()
    {
        ...
        $mock3 = $this->getMockBuilder(PartialMockTestClass::class)->getMock();
    ...
    {
        $mock = $this->getMockBuilder(AbstractMockTestClass::class)->getMock();
    ...
    {
        $mock = $this->getMockBuilder($type)->getMock();
    ...
    {
        $a = $this->getMockBuilder(stdClass::class)->getMock();
    ...
    public function testMockObjectsConstructedIndepentantlyShouldBeEqual()
    {
        ...
        $b = $this->getMockBuilder(stdClass::class)->getMock();
    ...
    {
        $x = $this->getMockBuilder(stdClass::class)->getMock();
    ...
    public function testVerificationOfMethodNameFailsWithoutParameters()
    {
        ...
        try {
            ...
            $this->assertSame('Expectation failed for method name is equal to "right" when invoked 1 time(s).' . PHP_EOL . 'Method was expected to be called 1 times, actually called 0 times.' . PHP_EOL, $e->getMessage());
        }
    ...
    public function testVerificationOfMethodNameFailsWithWrongParameters()
    {
        ...
        try {
            ...
            $this->assertSame('Expectation failed for method name is equal to "right" when invoked 1 time(s)' . PHP_EOL . 'Parameter 0 for invocation SomeClass::right(Array (...)) does not match expected value.' . PHP_EOL . 'Failed asserting that two arrays are equal.', $e->getMessage());
        }
    ...
    public function testVerificationOfNeverFailsWithEmptyParameters()
    {
        ...
        try {
            ...
            $this->assertSame('SomeClass::right() was not expected to be called.', $e->getMessage());
        }
    ...
    public function testWithAnythingInsteadOfWithAnyParameters()
    {
        ...
        try {
            ...
            $this->assertSame('Expectation failed for method name is equal to "right" when invoked 1 time(s)' . PHP_EOL . 'Parameter count for invocation SomeClass::right() is too low.' . PHP_EOL . 'To allow 0 or more parameters with any value, omit ->with() or use ->withAnyParameters() instead.', $e->getMessage());
        }
    ...
    public function testCreateMockFromWsdl()
    {
        ...
        $this->assertStringStartsWith('Mock_WsdlMock_', get_class($mock));
    }
    ...
    /**
     *
     * @see https://github.com/sebastianbergmann/phpunit-mock-objects/issues/156 @ticket 156
     */
    public function testInterfaceWithStaticMethodCanBeStubbed()
    {
        $this->assertInstanceOf(InterfaceWithStaticMethod::class, $this->getMockBuilder(InterfaceWithStaticMethod::class)
            ->getMock());
    }
    ...
    /**
     *
     * @see https://github.com/sebastianbergmann/phpunit-mock-objects/issues/171 @ticket 171
     */
    public function testStubForClassThatImplementsSerializableCanBeCreatedWithoutInvokingTheConstructor()
    {
        $this->assertInstanceOf(ClassThatImplementsSerializable::class, $this->getMockBuilder(ClassThatImplementsSerializable::class)
            ->disableOriginalConstructor()
            ->getMock());
    }
    ...
    {
        $this->assertInstanceOf(ClassWithSelfTypeHint::class, $this->getMockBuilder(ClassWithSelfTypeHint::class)
            ->getMock());
    }
    ...
    public function testParameterCallbackConstraintOnlyEvaluatedOnce()
    {
        ...
        $mock->expects($this->exactly($expectedNumberOfCalls))
            ->method('bar')
