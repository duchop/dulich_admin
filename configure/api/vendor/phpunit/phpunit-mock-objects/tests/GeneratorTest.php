...
class GeneratorTest extends TestCase
{
    ...
    public function testGetMockFailsWhenInvalidFunctionNameIsPassedInAsAFunctionToMock()
    {
        ...
        $this->generator->getMock(stdClass::class, [
            0
        ]);
    }
    ...
    {
        $mock = $this->generator->getMock(stdClass::class, [
            'testFunction'
        ]);
    ...
    {
        $mock = $this->generator->getMockForAbstractClass(AbstractMockTestClass::class, [], '', true, true, true, [
            'nonexistentMethod'
        ]);
    ...
    {
        $mock = $this->generator->getMockForTrait(AbstractTrait::class, [], '', true, true, true, [
            'nonexistentMethod'
        ]);
    ...
    {
        $mock = $this->generator->getMock(SingletonClass::class, [
            'doSomething'
        ], [], '', false);
    ...
    {
        $stub = $this->generator->getMock([
            AnInterfaceWithReturnType::class,
            AnInterface::class
        ]);
    ...
    public function testCanConfigureMethodsForDoubleOfNonExistentClass()
    {
        ...
        $mock = $this->generator->getMock($className, [
            'someMethod'
        ]);
