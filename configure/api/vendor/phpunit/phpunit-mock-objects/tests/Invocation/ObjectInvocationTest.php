...
class ObjectInvocationTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ObjectInvocation::class, new ObjectInvocation('FooClass', 'FooMethod', [
            'an_argument'
    ...
    {
        $invocation = new ObjectInvocation('FooClass', 'FooMethod', [
            'an_argument'
        ], 'ReturnType', new stdClass());
    ...
    public function testAllowToGetMethodParametersSetInConstructor()
    {
        ...
        $invocation = new ObjectInvocation('FooClass', 'FooMethod', $expectedParameters, 'ReturnType', new stdClass());
    ...
    public function testConstructorAllowToSetFlagCloneObjectsInParameters()
    {
        ...
        $invocation = new ObjectInvocation('FooClass', 'FooMethod', $parameters, 'ReturnType', new stdClass(), $cloneObjects);
    ...
    public function testAllowToGetReturnTypeSetInConstructor()
    {
        ...
        $invocation = new ObjectInvocation('FooClass', 'FooMethod', [
            'an_argument'
        ], $expectedReturnType, new stdClass());
