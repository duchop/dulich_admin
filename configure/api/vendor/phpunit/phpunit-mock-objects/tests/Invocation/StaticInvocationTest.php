...
class StaticInvocationTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(StaticInvocation::class, new StaticInvocation('FooClass', 'FooMethod', [
            'an_argument'
        ], 'ReturnType'));
    }
    ...
    {
        $invocation = new StaticInvocation('FooClass', 'FooMethod', [
            'an_argument'
        ], 'ReturnType');
    ...
    public function testAllowToGetMethodParametersSetInConstructor()
    {
        ...
        $invocation = new StaticInvocation('FooClass', 'FooMethod', $expectedParameters, 'ReturnType');
    ...
    public function testConstructorAllowToSetFlagCloneObjectsInParameters()
    {
        ...
        $invocation = new StaticInvocation('FooClass', 'FooMethod', $parameters, 'ReturnType', $cloneObjects);
