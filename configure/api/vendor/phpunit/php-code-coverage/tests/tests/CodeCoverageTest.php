...
class CodeCoverageTest extends TestCase
{
    ...
    public function testCanBeConstructedForXdebugWithoutGivenFilterObject()
    {
        ...
        $this->assertAttributeInstanceOf(Xdebug::class, 'driver', $this->coverage);
        
        $this->assertAttributeInstanceOf(Filter::class, 'filter', $this->coverage);
    }
    ...
    public function testCanBeConstructedForXdebugWithGivenFilterObject()
    {
        ...
        $this->assertAttributeInstanceOf(Xdebug::class, 'driver', $coverage);
    ...
    public function testCanBeConstructedForPhpdbgWithoutGivenFilterObject()
    {
        ...
        $this->assertAttributeInstanceOf(PHPDBG::class, 'driver', $this->coverage);
    ...
    public function testCanBeConstructedForPhpdbgWithGivenFilterObject()
    {
        ...
        $this->assertAttributeInstanceOf(PHPDBG::class, 'driver', $coverage);
    ...
    public function testGetLinesToBeIgnored2()
    {
        $this->assertEquals([
            ...
            ->invoke($this->coverage, TEST_FILES_PATH . 'source_without_ignore.php'));
    }
    ...
    public function testGetLinesToBeIgnored3()
    {
        $this->assertEquals([
            ...
            ->invoke($this->coverage, TEST_FILES_PATH . 'source_with_class_and_anonymous_function.php'));
    }
    ...
    public function testGetLinesToBeIgnoredOneLineAnnotations()
    {
        $this->assertEquals([
            ...
            ->invoke($this->coverage, TEST_FILES_PATH . 'source_with_oneline_annotations.php'));
    }
