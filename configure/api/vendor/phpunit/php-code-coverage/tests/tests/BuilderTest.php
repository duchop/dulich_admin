...
class BuilderTest extends TestCase
{
    ...
    {
        $method = new \ReflectionMethod(Builder::class, 'buildDirectoryStructure');
    ...
    {
        $method = new \ReflectionMethod(Builder::class, 'reducePaths');
        
        $method->setAccessible(true);
        
        $_commonPath = $method->invokeArgs($this->factory, [
            &$paths
        ]);
