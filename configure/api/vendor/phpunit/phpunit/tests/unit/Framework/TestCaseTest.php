...
class TestCaseTest extends TestCase
{
    ...
    {
        unset($GLOBALS['a'], $_ENV['b'], $_POST['c'], $_GET['d'], $_COOKIE['e'], $_SERVER['f'], $_FILES['g'], $_REQUEST['h'], $GLOBALS['i']);
    }

    public function testCaseToString()
    {
        $this->assertEquals('PHPUnit\Framework\TestCaseTest::testCaseToString', $this->toString());
    }
    ...
    public function testExceptionWithWrongMessage()
    {
        ...
        $this->assertEquals(1, $result->failureCount());
        $this->assertCount(1, $result);
        $this->assertEquals("Failed asserting that exception message 'A runtime error occurred' contains 'A logic error occurred'.", $test->getStatusMessage());
    }
    ...
    public function testSkipsIfRequiresHigherVersionOfPHPUnit()
    {
        ...
        $this->assertEquals(1, $result->skippedCount());
        $this->assertEquals('PHPUnit >= 1111111 is required.', $test->getStatusMessage());
    }
    ...
    public function testSkipsIfRequiresHigherVersionOfPHP()
    {
        ...
        $this->assertEquals(1, $result->skippedCount());
        $this->assertEquals('PHP >= 9999999 is required.', $test->getStatusMessage());
    }
    ...
    public function testSkipsIfRequiresNonExistingOs()
    {
        ...
        $this->assertEquals(1, $result->skippedCount());
        $this->assertEquals('Operating system matching /DOESNOTEXIST/i is required.', $test->getStatusMessage());
    }
    ...
    public function testSkipsIfRequiresNonExistingOsFamily()
    {
        ...
        $this->assertEquals(1, $result->skippedCount());
        $this->assertEquals('Operating system DOESNOTEXIST is required.', $test->getStatusMessage());
    }
    ...
    public function testSkipsIfRequiresExtensionWithAMinimumVersion()
    {
        ...
        $this->assertEquals('Extension testExt >= 1.8.0 is required.', $test->getStatusMessage());
    }
    ...
    {
        /** @var \Mockable $mock */
        $mock = $this->createConfiguredMock(\Mockable::class, [
            'foo' => false
        ]);
