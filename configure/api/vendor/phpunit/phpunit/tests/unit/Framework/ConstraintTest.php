...
class ConstraintTest extends TestCase
{
    ...
    {
        $constraint = Assert::logicalNot(Assert::arrayHasKey(0));
...
, TestFailure::exceptionToString($e));
    ...
    public function testConstraintFileNotExists()
    {
        ...
        $constraint = Assert::logicalNot(Assert::fileExists());
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::greaterThan(1));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::greaterThanOrEqual(1));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::anything());
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::equalTo(1));
...
, TestFailure::exceptionToString($e));
    ...
    public function testConstraintIsNotIdentical()
    {
        ...
        $constraint = Assert::logicalNot(Assert::identicalTo($a));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::isInstanceOf(\stdClass::class));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::isType('string'));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::lessThan(1));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::lessThanOrEqual(1));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::classHasAttribute('privateAttribute'));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::classHasStaticAttribute('privateStaticAttribute'));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::objectHasAttribute('privateAttribute'));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::matchesRegularExpression('/foo/'));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::stringStartsWith('prefix'));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::stringContains('foo'));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::stringContains('oryginał'));
    ...
    {
        $constraint = Assert::logicalNot(Assert::stringContains('oryginał', false));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(Assert::stringEndsWith('suffix'));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(new TraversableContains('foo'));
...
, TestFailure::exceptionToString($e));
    ...
    public function testAttributeNotEqualTo()
    {
        ...
        $constraint = Assert::logicalNot(Assert::attributeEqualTo('foo', 2));
        
        $this->assertTrue($constraint->evaluate($object, '', true));
        $this->assertEquals('attribute "foo" is not equal to 2', $constraint->toString());
        $this->assertCount(1, $constraint);
        
        $constraint = Assert::logicalNot(Assert::attributeEqualTo('foo', 1));
...
, TestFailure::exceptionToString($e));
    ...
    public function testConstraintCountWithAnIteratorWhichDoesNotImplementCountable()
    {
        ...
        $this->assertTrue($constraint->evaluate(new \TestIterator([
            1,
            2,
            3,
            4,
        ...
        $this->assertFalse($constraint->evaluate(new \TestIterator([
            1,
            2,
            3,
            4
    ...
    public function testConstraintCountWithAnObjectImplementingCountable()
    {
        ...
        $this->assertTrue($constraint->evaluate(new \ArrayObject([
            1,
            2,
            3,
            4,
        ...
        $this->assertFalse($constraint->evaluate(new \ArrayObject([
            1,
            2,
            3,
            4
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(new Count(2));
...
, TestFailure::exceptionToString($e));
    ...
    {
        $constraint = Assert::logicalNot(new SameSize([
            1,
            2
        ]));
