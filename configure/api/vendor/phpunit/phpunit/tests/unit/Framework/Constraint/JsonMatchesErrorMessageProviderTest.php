...
class JsonMatchesErrorMessageProviderTest extends TestCase
{
    ...
    {
        $this->assertEquals($expected, JsonMatchesErrorMessageProvider::translateTypeToPrefix($type));
    }
    ...
    {
        $this->assertEquals($expected, JsonMatchesErrorMessageProvider::determineJsonError($error, $prefix));
    }
