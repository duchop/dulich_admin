...
EOF;
    ...
    public function testShouldRunFileSectionAsTest()
    {
        ...
        $this->phpProcess->expects($this->once())
            ->method('runJob')
            ->with($fileSection)
    ...
    {
        $this->setPhpContent($this->ensureCorrectEndOfLine(<<<EOF
--TEST--
...
EOF
    ...
    public function testRenderSkipifSection()
    {
        ...
        $this->phpProcess->expects($this->at(0))
            ->method('runJob')
            ->with($renderedCode)
            ->will($this->returnValue([
            'stdout' => '',
    ...
    public function testShouldRunCleanSectionWhenDefined()
    {
        ...
        $this->phpProcess->expects($this->at(1))
            ->method('runJob')
            ->with($cleanSection);
