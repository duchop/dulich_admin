...
class TestTest extends TestCase
{
    ...
    {
        $this->assertEquals($result, Test::getRequirements(\RequirementsTest::class, $test));
    }
    ...
    public function testGetRequirementsWithVersionConstraints($test, array $result)
    {
        ...
        foreach ($result as $type => $expected_requirement) {
            $this->assertArrayHasKey("{$type}_constraint", $requirements);
            $this->assertArrayHasKey('constraint', $requirements["{$type}_constraint"]);
            $this->assertInstanceOf(VersionConstraint::class, $requirements["{$type}_constraint"]['constraint']);
            $this->assertSame($expected_requirement['constraint'], $requirements["{$type}_constraint"]['constraint']->asString());
        }
    }
    ...
    public function testGetRequirementsMergesClassAndMethodDocBlocks()
    {
        ...
        $this->assertEquals($expectedAnnotations, Test::getRequirements(\RequirementsClassDocBlockTest::class, 'testMethod'));
    }
    ...
    {
        $this->assertEquals($result, Test::getMissingRequirements(\RequirementsTest::class, $test));
    }
    ...
    public function testGetLinesToBeCovered($test, $lines)
    {
        ...
        $this->assertEquals($expected, Test::getLinesToBeCovered($test, 'testSomething'));
    }
    ...
    public function testGetLinesToBeCovered2()
    {
        ...
        Test::getLinesToBeCovered('NotExistingCoveredElementTest', 'testOne');
    }
    ...
    public function testGetLinesToBeCovered3()
    {
        ...
        Test::getLinesToBeCovered('NotExistingCoveredElementTest', 'testTwo');
    }
    ...
    public function testGetLinesToBeCovered4()
    {
        ...
        Test::getLinesToBeCovered('NotExistingCoveredElementTest', 'testThree');
    }

    public function testGetLinesToBeCoveredSkipsNonExistentMethods()
    {
        $this->assertSame([], Test::getLinesToBeCovered('NotExistingCoveredElementTest', 'methodDoesNotExist'));
    }
    ...
    public function testTwoCoversDefaultClassAnnotationsAreNotAllowed()
    {
        ...
        Test::getLinesToBeCovered('CoverageTwoDefaultClassAnnotations', 'testSomething');
    }
    ...
    public function testFunctionParenthesesAreAllowed()
    {
        ...
        ], Test::getLinesToBeCovered('CoverageFunctionParenthesesTest', 'testSomething'));
    }
    ...
    public function testFunctionParenthesesAreAllowedWithWhitespace()
    {
        $this->assertSame([
            TEST_FILES_PATH . 'CoveredFunction.php' => \range(2, 4)
        ], Test::getLinesToBeCovered('CoverageFunctionParenthesesWhitespaceTest', 'testSomething'));
    }
    ...
    public function testMethodParenthesesAreAllowed()
    {
        ...
        ], Test::getLinesToBeCovered('CoverageMethodParenthesesTest', 'testSomething'));
    }
    ...
    public function testMethodParenthesesAreAllowedWithWhitespace()
    {
        $this->assertSame([
            TEST_FILES_PATH . 'CoveredClass.php' => \range(31, 35)
        ], Test::getLinesToBeCovered('CoverageMethodParenthesesWhitespaceTest', 'testSomething'));
    }
    ...
    public function testNamespacedFunctionCanBeCoveredOrUsed()
    {
        ...
        ], Test::getLinesToBeCovered(\CoverageNamespacedFunctionTest::class, 'testFunc'));
    }
