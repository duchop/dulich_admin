...
class ConfigurationTest extends TestCase
{
    ...
    {
        $this->configuration = Configuration::getInstance(TEST_FILES_PATH . 'configuration.xml');
    }
    ...
    {
        $configurationWithXinclude = Configuration::getInstance(TEST_FILES_PATH . 'configuration_xinclude.xml');
    ...
    {
        $emptyConfiguration = Configuration::getInstance(TEST_FILES_PATH . 'configuration_empty.xml');
    ...
    protected function assertConfigurationEquals(Configuration $expectedConfiguration, Configuration $actualConfiguration)
    {
        ...
        $this->assertEquals($expectedConfiguration->getTestSuiteConfiguration()
            ->tests(), $actualConfiguration->getTestSuiteConfiguration()
            ->tests());
    }

    public function testGetTestSuiteNamesReturnsTheNamesIfDefined()
    {
        $configuration = Configuration::getInstance(TEST_FILES_PATH . 'configuration.suites.xml');
    ...
    {
        $configuration = Configuration::getInstance(TEST_FILES_PATH . 'configuration.one-file-suite.xml');
