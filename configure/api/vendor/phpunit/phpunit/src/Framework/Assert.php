...
abstract class Assert
{
    ...
    public static function assertContains($needle, $haystack, $message = '', $ignoreCase = false, $checkForObjectIdentity = true, $checkForNonObjectIdentity = false)
    {
        if (\is_array($haystack) || (\is_object($haystack) && $haystack instanceof Traversable)) {
            $constraint = new TraversableContains($needle, $checkForObjectIdentity, $checkForNonObjectIdentity);
    ...
    {
        if (\is_array($haystack) || (\is_object($haystack) && $haystack instanceof Traversable)) {
            $constraint = new LogicalNot(new TraversableContains($needle, $checkForObjectIdentity, $checkForNonObjectIdentity));
        } elseif (\is_string($haystack)) {
            if (! \is_string($needle)) {
                throw InvalidArgumentHelper::factory(1, 'string');
            }
            
            $constraint = new LogicalNot(new StringContains($needle, $ignoreCase));
        } else {
            throw InvalidArgumentHelper::factory(2, 'array, traversable or string');
        }
    ...
    {
        if (! \is_array($haystack) && ! (\is_object($haystack) && $haystack instanceof Traversable)) {
            throw InvalidArgumentHelper::factory(2, 'array or traversable');
        }
    ...
    {
        $constraint = new IsEqual($expected, $delta, $maxDepth, $canonicalize, $ignoreCase);
    ...
    {
        $constraint = new LogicalNot(new IsEqual($expected, $delta, $maxDepth, $canonicalize, $ignoreCase));
    ...
    public static function assertClassHasAttribute($attributeName, $className, $message = '')
    {
        ...
        $constraint = new ClassHasAttribute($attributeName);
    ...
    public static function assertClassNotHasAttribute($attributeName, $className, $message = '')
    {
        ...
        $constraint = new LogicalNot(new ClassHasAttribute($attributeName));
    ...
    public static function assertClassHasStaticAttribute($attributeName, $className, $message = '')
    {
        ...
        $constraint = new ClassHasStaticAttribute($attributeName);
    ...
    public static function assertClassNotHasStaticAttribute($attributeName, $className, $message = '')
    {
        ...
        $constraint = new LogicalNot(new ClassHasStaticAttribute($attributeName));
    ...
    public static function assertObjectHasAttribute($attributeName, $object, $message = '')
    {
        ...
        $constraint = new ObjectHasAttribute($attributeName);
    ...
    public static function assertObjectNotHasAttribute($attributeName, $object, $message = '')
    {
        ...
        $constraint = new LogicalNot(new ObjectHasAttribute($attributeName));
    ...
    public static function assertNotSame($expected, $actual, $message = '')
    {
        if (\is_bool($expected) && \is_bool($actual)) {
            ...
            $constraint = new LogicalNot(new IsIdentical($expected));
    ...
    public static function assertNotInstanceOf($expected, $actual, $message = '')
    {
        ...
        $constraint = new LogicalNot(new IsInstanceOf($expected));
    ...
    public static function assertNotInternalType($expected, $actual, $message = '')
    {
        ...
        $constraint = new LogicalNot(new IsType($expected));
    ...
    public static function assertNotRegExp($pattern, $string, $message = '')
    {
        ...
        $constraint = new LogicalNot(new RegularExpression($pattern));
    ...
    public static function assertNotSameSize($expected, $actual, $message = '')
    {
        ...
        $constraint = new LogicalNot(new SameSize($expected));
    ...
    public static function assertStringMatchesFormatFile($formatFile, $string, $message = '')
    {
        ...
        $constraint = new StringMatchesFormatDescription(\file_get_contents($formatFile));
    ...
    public static function assertStringNotMatchesFormatFile($formatFile, $string, $message = '')
    {
        ...
        $constraint = new LogicalNot(new StringMatchesFormatDescription(\file_get_contents($formatFile)));
    ...
    public static function assertJsonStringEqualsJsonString($expectedJson, $actualJson, $message = '')
    {
        ...
        $constraint = new JsonMatches($expectedJson);
    ...
    public static function getStaticAttribute($className, $attributeName)
    {
        ...
        throw new Exception(\sprintf('Attribute "%s" not found in class.', $attributeName));
    }
