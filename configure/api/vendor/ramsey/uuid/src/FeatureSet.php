...
class FeatureSet
{
     ...
     *            Whether to force the use of 32-bit functionality
     *            (primarily for testing purposes)
     * @param bool $forceNoBigNumber
     *            Whether to disable the use of moontoast/math
     *            `BigNumber` (primarily for testing purposes)
     * @param bool $ignoreSystemNode
     *            Whether to disable attempts to check for
     *            the system host ID (primarily for testing purposes)
     * @param bool $enablePecl
     *            Whether to enable the use of the `PeclUuidTimeGenerator`
    ...
    protected function buildTimeGenerator(TimeProviderInterface $timeProvider)
    {
        ...
        return (new TimeGeneratorFactory($this->nodeProvider, $this->buildTimeConverter(), $timeProvider))->getGenerator();
    }
