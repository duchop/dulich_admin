...
class BaseTest extends TestCase
{
    ...
    {
        $this->assertInternalType('array', BaseProvider::shuffle(array(
            1,
            2,
            3
        )));
    ...
    public function regexifyBasicDataProvider()
    {
        return array(
            array(
                'azeQSDF1234',
                'azeQSDF1234',
                'does not change non regex chars'
            ),
            array(
                'foo(bar){1}',
                'foobar',
                'replaces regex characters'
            ),
            array(
                '',
                '',
    ...
    public function regexifyDataProvider()
    {
        return array(
            ...
            array(
                '[a-z1-9]',
                'multiple character class range'
            ),
            array(
                'a*b+c?',
            ...
            array(
                'a{2,3}',
                'min-max brackets quantifiers'
            ),
            array(
                '[aeiou]{2,3}',
                'brackets quantifiers on basic character class'
            ),
            array(
                '[a-z]{2,3}',
                'brackets quantifiers on character class range'
            ),
            array(
                '(a|b){2,3}',
                'brackets quantifiers on alternation'
            ),
            array(
                '\.\*\?\+',
                'escaped characters'
    ...
    public function testOptionalAllowsChainingPropertyAccess()
    {
        $faker = new \Faker\Generator();
        $faker->addProvider(new \Faker\Provider\Base($faker));
        $faker->addProvider(new \ArrayObject(array(
            1
    ...
    public function testOptionalAllowsChainingMethodCall()
    {
        ...
        $this->assertEquals(1, $faker->optional(100)
            ->count());
        $this->assertNull($faker->optional(0)
            ->count());
    }
    ...
    public function testOptionalPercentageAndWeight()
    {
        ...
        $this->assertEquals(round(array_sum($valuesOld) / 10000, 2), round(array_sum($valuesNew) / 10000, 2));
    }
    ...
    public function testUniqueAllowsChainingMethodCall()
    {
        ...
        $this->assertEquals(1, $faker->unique()
            ->count());
    }
    ...
    public function testValidAllowsChainingMethodCall()
    {
        $faker = new \Faker\Generator();
        $faker->addProvider(new \Faker\Provider\Base($faker));
        $this->assertLessThan(10, $faker->valid()
            ->numberBetween(5, 9));
    }
    ...
    public function testValidThrowsExceptionWhenNoValidValueCanBeGenerated()
    {
        ...
        for ($i = 0; $i < 11; $i ++) {
            $faker->valid($evenValidator)->randomElement(array(
                1,
                3,
                5,
                7,
    ...
    public function testValidThrowsExceptionWhenParameterIsNotCollable()
    {
        $faker = new \Faker\Generator();
        $faker->addProvider(new \Faker\Provider\Base($faker));
        $faker->valid(12)->randomElement(array(
            1,
            3,
            5,
            7,
    ...
    {
        BaseProvider::randomElements(array(
            'foo'
        ), 2);
    }
    ...
    public function testRandomElements()
    {
        ...
        $shuffled = BaseProvider::randomElements(array(
            'foo',
            'bar',
            'baz'
        ), 3);
        ...
        $allowDuplicates = BaseProvider::randomElements(array(
            'foo',
            'bar'
        ), 3, true);
