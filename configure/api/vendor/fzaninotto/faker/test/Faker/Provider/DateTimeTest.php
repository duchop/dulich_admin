...
class DateTimeTest extends TestCase
{
    ...
    public function testPreferDefaultTimezoneOverSystemTimezone()
    {
        ...
        $this->assertNotSame($systemTimezone, $date->getTimezone()
            ->getName());
        $this->assertSame($this->defaultTz, $date->getTimezone()
            ->getName());
    ...
    public function testUseSystemTimezoneWhenDefaultTimezoneIsNotSet()
    {
         ...
         */
        $date = DateTimeProvider::dateTime();
        $this->assertSame($systemTimezone, $date->getTimezone()
            ->getName());
        $this->assertNotSame($this->defaultTz, $date->getTimezone()
            ->getName());
