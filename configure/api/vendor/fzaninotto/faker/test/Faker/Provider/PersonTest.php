...
class PersonTest extends TestCase
{
    ...
    {
        $this->assertContains(Person::firstNameMale(), array(
            'John'
        ));
    }
    ...
    {
        $this->assertContains(Person::firstNameFemale(), array(
            'Jane'
        ));
    }
    ...
    {
        $this->assertContains(Person::titleMale(), array(
            'Mr.',
            'Dr.',
            'Prof.'
        ));
    ...
    {
        $this->assertContains(Person::titleFemale(), array(
            'Mrs.',
            'Ms.',
            'Miss',
            'Dr.',
    ...
    public function testNameReturnsFirstNameAndLastName()
    {
        $faker = new Generator();
        $faker->addProvider(new Person($faker));
        $this->assertContains($faker->name(), array(
            'John Doe',
            'Jane Doe'
        ));
        $this->assertContains($faker->name('foobar'), array(
            'John Doe',
            'Jane Doe'
        ));
        $this->assertContains($faker->name('male'), array(
            'John Doe'
        ));
        $this->assertContains($faker->name('female'), array(
            'Jane Doe'
        ));
    }
}
