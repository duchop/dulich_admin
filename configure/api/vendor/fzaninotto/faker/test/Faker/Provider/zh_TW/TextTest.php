...
class TextTest extends TestCase
{
    ...
    function testItShouldExplodeTheStringToArray()
    {
        $this->assertSame(array(
            ...
            '有',
            '趣'
        ), $this->getMethod('explode')
            ->invokeArgs(null, array(
            '中文測試真有趣'
        )));
    ...
    {
        $this->assertContains($this->getMethod('strlen')
            ->invokeArgs(null, array(
            '中文測試真有趣'
        )), array(
            7,
    ...
    {
        $this->assertTrue($this->getMethod('validStart')
            ->invokeArgs(null, array(
            '中'
        )));
        ...
        $this->assertFalse($this->getMethod('validStart')
            ->invokeArgs(null, array(
            '。'
        )));
    ...
    {
        $this->assertSame('中文測試真有趣。', $this->getMethod('appendEnd')
            ->invokeArgs(null, array(
            '中文測試真有趣'
        )));
