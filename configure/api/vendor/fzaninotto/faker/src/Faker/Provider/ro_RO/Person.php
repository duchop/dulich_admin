...
class Person extends \Faker\Provider\Person
{
     ...
     *            Person::GENDER_MALE or Person::GENDER_FEMALE
     * @param null|string $dateOfBirth
     *            (1800-2099) 'Y-m-d', 'Y-m', 'Y' I.E. '1981-06-16', '2085-03', '1900'
     * @param null|string $county
     *            county code where the CNP was issued
     * @param null|bool $isResident
     *            flag if the person resides in Romania
    ...
    protected function getDateOfBirth($dateOfBirth)
    {
        if (empty($dateOfBirth)) {
            $dateOfBirthParts = array(
                static::numberBetween(1800, 2099)
            );
        } else {
