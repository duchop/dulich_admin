...
class Lorem extends Base
{
     ...
     * @param integer $nbSentences
     *            around how many sentences the paragraph should contain
     * @param boolean $variableNbSentences
     ...
     * @param bool $asText
     *            if true the paragraphs are returned as one string, separated by two newlines
     * @return array|string
     */
