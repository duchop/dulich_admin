...
class File extends Base
{
    ...
    /**
     * MIME types from the apache.org file.
     * Some types are truncated.
     *
    ...
    public static function file($sourceDirectory = '/tmp', $targetDirectory = '/tmp', $fullPath = true)
    {
        ...
        $files = array_filter(array_values(array_diff(scandir($sourceDirectory), array(
            '.',
            '..'
