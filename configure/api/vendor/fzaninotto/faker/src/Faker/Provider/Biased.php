...
class Biased extends Base
{
     ...
     *
     * @param integer $min
     *            Minimum value of the generated integers.
     * @param integer $max
     *            Maximum value of the generated integers.
     * @param callable $function
     *            A function mapping x ∈ [0, 1] onto a double ∈ [0, 1]
    ...
    /**
     * 'linearLow' favors lower numbers.
    ...
    /**
     * 'linearHigh' favors higher numbers.
