...
class IsArrayContainingTest extends AbstractMatcherTest
{
    ...
    {
        $this->assertMatches(hasItemInArray('a'), array(
            'a',
            'b',
            'c'
    ...
    {
        $this->assertDoesNotMatch(hasItemInArray('a'), array(
            'b',
            'c'
        ), "should not matches array that doesn't contain 'a'");
        $this->assertDoesNotMatch(hasItemInArray('a'), array(), 'should not match empty array');
    }
