...
class IsArrayTest extends AbstractMatcherTest
{
    ...
    {
        $this->assertMatches(anArray(array(
            equalTo('a'),
            equalTo('b'),
            equalTo('c')
        )), array(
    ...
    {
        $this->assertDoesNotMatch(anArray(array(
            equalTo('a'),
            equalTo('b')
        )), array(
            'b',
    ...
    public function testDoesNotMatchNull()
    {
        $this->assertDoesNotMatch(anArray(array(
            equalTo('a')
        )), null, 'should not match null');
    }

    public function testHasAReadableDescription()
    {
        $this->assertDescription('["a", "b"]', anArray(array(
            equalTo('a'),
            equalTo('b')
        )));
    }
    ...
    {
        $this->assertMismatchDescription('array keys were [<1>, <2>]', anArray(array(
            equalTo('a'),
            equalTo('b')
        )), array(
            1 => 'a',
