...
class IsArrayWithSizeTest extends AbstractMatcherTest
{
    ...
    {
        $this->assertMatches(arrayWithSize(equalTo(3)), array(
            1,
            2,
            3
        ), 'correct size');
        $this->assertDoesNotMatch(arrayWithSize(equalTo(2)), array(
            1,
            2,
            3
        ), 'incorrect size');
    ...
    {
        $this->assertMatches(arrayWithSize(3), array(
            1,
            2,
            3
        ), 'correct size');
        $this->assertDoesNotMatch(arrayWithSize(2), array(
            1,
            2,
            3
        ), 'incorrect size');
    ...
    public function testEmptyArray()
    {
        ...
        $this->assertDoesNotMatch(emptyArray(), array(
            1
        ), 'incorrect size');
    }
