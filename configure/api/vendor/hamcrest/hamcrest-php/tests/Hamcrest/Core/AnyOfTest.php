...
class AnyOfTest extends \Hamcrest\AbstractMatcherTest
{
    ...
    {
        $combined = anyOf(equalTo(new \Hamcrest\Core\SampleBaseClass('good')), equalTo(new \Hamcrest\Core\SampleBaseClass('ugly')), equalTo(new \Hamcrest\Core\SampleSubClass('good')));
    ...
    {
        $this->assertDescription('("good" or "bad" or "ugly")', anyOf('good', 'bad', 'ugly'));
    }
    ...
    {
        $combined = noneOf(equalTo(new \Hamcrest\Core\SampleBaseClass('good')), equalTo(new \Hamcrest\Core\SampleBaseClass('ugly')), equalTo(new \Hamcrest\Core\SampleSubClass('good')));
