...
class IsCollectionContainingTest extends \Hamcrest\AbstractMatcherTest
{
    ...
    public function testMatchesACollectionThatContainsAnElementMatchingTheGivenMatcher()
    {
        ...
        $this->assertMatches($itemMatcher, array(
            'a',
            'b',
            'c'
    ...
    public function testDoesNotMatchCollectionThatDoesntContainAnElementMatchingTheGivenMatcher()
    {
        ...
        $this->assertDoesNotMatch($matcher1, array(
            'b',
            'c'
        ), "should not match list that doesn't contain 'a'");
        
        $matcher2 = hasItem(equalTo('a'));
        $this->assertDoesNotMatch($matcher2, array(), 'should not match the empty list');
    }

    public function testDoesNotMatchNull()
    {
        $this->assertDoesNotMatch(hasItem(equalTo('a')), null, 'should not match null');
    }
    ...
    public function testMatchesAllItemsInCollection()
    {
        ...
        $this->assertMatches($matcher1, array(
            'a',
            'b',
            'c'
        ...
        $this->assertMatches($matcher2, array(
            'a',
            'b',
            'c'
        ...
        $this->assertMatches($matcher3, array(
            'c',
            'b',
            'a'
        ...
        $this->assertMatches($matcher4, array(
            'e',
            'c',
            'b',
            'a',
        ...
        $this->assertDoesNotMatch($matcher5, array(
            'e',
            'c',
            'b',
            'd'
