...
class IsInstanceOfTest extends \Hamcrest\AbstractMatcherTest
{
    ...
    public function testEvaluatesToFalseIfArgumentIsNotAnObject()
    {
        ...
        assertThat(array(
            ...
            2,
            3
        ), not(anInstanceOf('Hamcrest\Core\SampleBaseClass')));
    }
    ...
    {
        $this->assertMismatchDescription('[Hamcrest\Core\SampleBaseClass] <good>', anInstanceOf('Hamcrest\Core\SampleSubClass'), $this->_baseClassInstance);
    }
}
