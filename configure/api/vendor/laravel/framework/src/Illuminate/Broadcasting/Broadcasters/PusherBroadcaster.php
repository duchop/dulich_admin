...
class PusherBroadcaster extends Broadcaster
{
    ...
    {
        if (Str::startsWith($request->channel_name, [
            'private-',
            'presence-'
        ]) && ! $request->user()) {
    ...
    public function validAuthenticationResponse($request, $result)
    {
        ...
        return $this->decodePusherResponse($this->pusher->presence_auth($request->channel_name, $request->socket_id, $request->user()
            ->getAuthIdentifier(), $result));
    }
