...
class TransportManager extends Manager
{
    ...
    protected function createSesDriver()
    {
        ...
        return new SesTransport(new SesClient($this->addSesCredentials($config)));
    }
    ...
    protected function createMailgunDriver()
    {
        ...
        return new MailgunTransport($this->guzzle($config), $config['secret'], $config['domain']);
    }
    ...
    protected function createSparkPostDriver()
    {
        ...
        return new SparkPostTransport($this->guzzle($config), $config['secret'], $config['options'] ?? []);
    }
    ...
    {
        return new HttpClient(Arr::add($config['guzzle'] ?? [], 'connect_timeout', 60));
    }
