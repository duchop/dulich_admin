...
class Markdown
{
    ...
    public function render($view, array $data = [], $inliner = null)
    {
        ...
        $contents = $this->view->replaceNamespace('mail', $this->htmlComponentPaths())
            ->make($view, $data)
            ->render();
        
        return new HtmlString(($inliner ?  : new CssToInlineStyles())->convert($contents, $this->view->make('mail::themes.' . $this->theme)
            ->render()));
    }
    ...
    public function renderText($view, array $data = [])
    {
        ...
        $contents = $this->view->replaceNamespace('mail', $this->markdownComponentPaths())
            ->make($view, $data)
            ->render();
