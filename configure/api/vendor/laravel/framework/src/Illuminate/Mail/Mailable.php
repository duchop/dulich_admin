...
class Mailable implements MailableContract, Renderable
{
    ...
    public function queue(Queue $queue)
    {
        ...
        return $queue->connection($connection)->pushOn($queueName ?  : null, new SendQueuedMailable($this));
    }
    ...
    public function later($delay, Queue $queue)
    {
        ...
        return $queue->connection($connection)->laterOn($queueName ?  : null, $delay, new SendQueuedMailable($this));
    }
    ...
    {
        $expected = $this->normalizeRecipient($this->addressesToArray($address, $name)[0]);
