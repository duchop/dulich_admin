...
class LogServiceProvider extends ServiceProvider
{
    ...
    {
        if ($this->app->bound('config') && $channel = $this->app->make('config')->get('app.log_channel')) {
            return $channel;
        }
    ...
    {
        $log->useFiles($this->app->make('config')->get('app.log_path'), $this->logLevel());
    }
    ...
    {
        $log->useDailyFiles($this->app->make('config')->get('app.log_path'), $this->maxFiles(), $this->logLevel());
    }
