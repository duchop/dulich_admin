...
class Handler implements ExceptionHandlerContract
{
    ...
    public function report(Exception $e)
    {
        ...
        $logger->error($e->getMessage(), array_merge($this->context(), [
            'exception' => $e
        ]));
    }
    ...
    protected function invalid($request, ValidationException $exception)
    {
        ...
        return redirect($url)->withInput($request->except($this->dontFlash))
    ...
    protected function convertExceptionToResponse(Exception $e)
    {
        ...
        try {
            $content = config('app.debug') && class_exists(Whoops::class) ? $this->renderExceptionWithWhoops($e) : $this->renderExceptionWithSymfony($e, config('app.debug'));
        } catch (Exception $e) {
    ...
    protected function prepareJsonResponse($request, Exception $e)
    {
        ...
        return new JsonResponse($this->convertExceptionToArray($e), $status, $headers, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES);
    }
