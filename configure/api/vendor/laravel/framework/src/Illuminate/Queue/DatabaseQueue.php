...
class DatabaseQueue extends Queue implements QueueContract
{
    ...
    public function bulk($jobs, $data = '', $queue = null)
    {
        ...
        return $this->database->table($this->table)->insert(collect((array) $jobs)->map(function ($job) use($queue, $data, $availableAt) {
    ...
    {
        return $this->database->table($this->table)->insertGetId($this->buildDatabaseRecord($this->getQueue($queue), $payload, $this->availableAt($delay), $attempts));
    }
