...
class ListenCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $queue = $this->getQueue($connection = $this->input->getArgument('connection'));
    ...
    protected function getQueue($connection)
    {
        ...
        return $this->input->getOption('queue') ?  : $this->laravel['config']->get("queue.connections.{$connection}.queue", 'default');
    }
    ...
    {
        return new ListenerOptions($this->option('env'), $this->option('delay'), $this->option('memory'), $this->option('timeout'), $this->option('sleep'), $this->option('tries'), $this->option('force'));
    }
