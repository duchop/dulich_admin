...
class BeanstalkdQueue extends Queue implements QueueContract
{
    ...
    {
        return $this->pheanstalk->useTube($this->getQueue($queue))
            ->put($payload, Pheanstalk::DEFAULT_PRIORITY, Pheanstalk::DEFAULT_DELAY, $this->timeToRun);
    }
    ...
    public function later($delay, $job, $data = '', $queue = null)
    {
        ...
        return $pheanstalk->put($this->createPayload($job, $data), Pheanstalk::DEFAULT_PRIORITY, $this->secondsUntil($delay), $this->timeToRun);
    }
