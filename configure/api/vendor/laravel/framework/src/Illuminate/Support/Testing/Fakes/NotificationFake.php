...
class NotificationFake implements NotificationFactory, NotificationDispatcher
{
    ...
    {
        PHPUnit::assertTrue(($count = $this->sent($notifiable, $notification)->count()) === $times, "The expected [{$notification}] notification was sent {$count} times instead of {$times} times.");
    }
    ...
    public function assertNotSentTo($notifiable, $notification, $callback = null)
    {
        ...
        PHPUnit::assertTrue($this->sent($notifiable, $notification, $callback)->count() === 0, "The unexpected [{$notification}] notification was sent.");
    }
