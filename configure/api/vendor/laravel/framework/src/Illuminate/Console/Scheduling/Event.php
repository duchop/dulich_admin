...
class Event
{
    ...
    protected function runCommandInForeground(Container $container)
    {
        ...
        (new Process($this->buildCommand(), base_path(), null, null, null))->run();
    ...
    {
        return Carbon::instance(CronExpression::factory($this->getExpression())->getNextRunDate($currentTime, $nth, $allowCurrentDate));
    }
