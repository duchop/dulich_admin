...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    {
        return $this->newEloquentBuilder($this->newBaseQueryBuilder())
            ->setModel($this);
    }
    ...
    {
        return $this->registerGlobalScopes($this->newEloquentBuilder($this->newBaseQueryBuilder())
            ->setModel($this));
    }
    ...
    public function fresh($with = [])
    {
        ...
        return static::newQueryWithoutScopes()->with(is_string($with) ? func_get_args() : $with)
    ...
    public function refresh()
    {
        ...
        $this->load(collect($this->relations)->except('pivot')
            ->keys()
            ->toArray());
