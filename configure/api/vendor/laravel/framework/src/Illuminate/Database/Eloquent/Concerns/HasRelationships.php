...
trait HasRelationships
{
    ...
    {
        return $this->newMorphTo($this->newQuery()
            ->setEagerLoads([]), $this, $id, null, $type, $name);
    }
    ...
    protected function morphInstanceTo($target, $name, $type, $id)
    {
        ...
        return $this->newMorphTo($instance->newQuery(), $this, $id, $instance->getKeyName(), $type, $name);
    }
    ...
    public function hasManyThrough($related, $through, $firstKey = null, $secondKey = null, $localKey = null, $secondLocalKey = null)
    {
        ...
        return $this->newHasManyThrough($this->newRelatedInstance($related)
            ->newQuery(), $this, $through, $firstKey, $secondKey, $localKey ?  : $this->getKeyName(), $secondLocalKey ?  : $through->getKeyName());
    }
