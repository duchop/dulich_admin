...
class Builder
{
    ...
    public function getColumnType($table, $column)
    {
        ...
        return $this->connection->getDoctrineColumn($table, $column)
            ->getType()
            ->getName();
    }
    ...
    {
        $results = $this->connection->select($this->grammar->compileColumnListing($this->connection->getTablePrefix() . $table));
