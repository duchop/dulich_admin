...
class HasManyThrough extends Relation
{
    ...
    {
        return in_array(SoftDeletes::class, class_uses_recursive(get_class($this->throughParent)));
    }
    ...
    public function find($id, $columns = ['*'])
    {
        ...
        return $this->where($this->getRelated()
            ->getQualifiedKeyName(), '=', $id)
            ->first($columns);
    }
    ...
    public function findMany($ids, $columns = ['*'])
    {
        ...
        return $this->whereIn($this->getRelated()
            ->getQualifiedKeyName(), $ids)
            ->get($columns);
    }
    ...
    public function get($columns = ['*'])
    {
        ...
        $models = $builder->addSelect($this->shouldSelect($columns))
            ->getModels();
    ...
    public function getRelationExistenceQueryForSelfRelation(Builder $query, Builder $parentQuery, $columns = ['*'])
    {
        ...
        return $query->select($columns)->whereColumn($parentQuery->getQuery()->from . '.' . $query->getModel()
            ->getKeyName(), '=', $this->getQualifiedFirstKeyName());
    }
