...
trait QueriesRelationships
{
    ...
    public function has($relation, $operator = '>=', $count = 1, $boolean = 'and', Closure $callback = null)
    {
        ...
        $hasQuery = $relation->{$method}($relation->getRelated()
            ->newQuery(), $this);
    ...
    public function withCount($relations)
    {
        ...
        foreach ($this->parseWithRelations($relations) as $name => $constraints) {
            ...
            $query = $relation->getRelationExistenceCountQuery($relation->getRelated()
                ->newQuery(), $this);
    ...
    public function mergeConstraintsFrom(Builder $from)
    {
        ...
        return $this->withoutGlobalScopes($from->removedScopes())
            ->mergeWheres($from->getQuery()->wheres, $whereBindings);
    }
