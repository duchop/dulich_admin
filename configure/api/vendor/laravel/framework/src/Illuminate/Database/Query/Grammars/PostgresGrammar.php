...
class PostgresGrammar extends Grammar
{
    ...
    public function compileInsert(Builder $query, array $values)
    {
        ...
        return empty($values) ? "insert into {$table} DEFAULT VALUES" : parent::compileInsert($query, $values);
    }
    ...
    public function compileDelete(Builder $query)
    {
        ...
        return isset($query->joins) ? $this->compileDeleteWithJoins($query, $table) : parent::compileDelete($query);
    }
