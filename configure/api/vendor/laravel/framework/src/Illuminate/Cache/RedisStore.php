...
class RedisStore extends TaggableStore implements Store
{
    ...
    {
        $this->connection()->setex($this->prefix . $key, (int) max(1, $minutes * 60), $this->serialize($value));
    }
    ...
    public function add($key, $value, $minutes)
    {
        ...
        return (bool) $this->connection()->eval($lua, 1, $this->prefix . $key, $this->serialize($value), (int) max(1, $minutes * 60));
    }
