...
class PhpRedisConnection extends Connection
{
    ...
    public function exists(...$keys)
    {
        ...
        return $this->executeRaw(array_merge([
            'exists'
        ], $keys));
    }
    ...
    public function hmget($key, ...$dictionary)
    {
        ...
        return array_values($this->command('hmget', [
            $key,
            $dictionary
        ]));
    }
    ...
    {
        return $this->zInter($output, $keys, $options['weights'] ?? null, $options['aggregate'] ?? 'sum');
    }
    ...
    {
        return $this->zUnion($output, $keys, $options['weights'] ?? null, $options['aggregate'] ?? 'sum');
    }
