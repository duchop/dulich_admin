<div
    class="frames-description <?php echo $has_frames_tabs ? 'frames-description-application' : '' ?>">
  <?php if ($has_frames_tabs): ?>
    <?php if ($active_frames_tab == 'application'): ?>
      <span href="#" id="application-frames-tab"
        class="frames-tab frames-tab-active">
    ...
    <a href="#" id="all-frames-tab"
        class="frames-tab <?php echo $active_frames_tab == 'all' ? 'frames-tab-active' : '' ?>">
