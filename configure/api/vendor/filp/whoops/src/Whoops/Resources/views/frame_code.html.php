...
?>
<div
    class="frame-code-container <?php echo (!$has_frames ? 'empty' : '') ?>">
  <?php foreach ($frames as $i => $frame): ?>
    <?php $line = $frame->getLine(); ?>
      <div class="frame-code <?php echo ($i == 0 ) ? 'active' : '' ?>"
        ...
        <div class="frame-file">
          ...
          <?php if ($filePath && $editorHref = $handler->getEditorHref($filePath, (int) $line)): ?>
            ...
            <a href="<?php echo $editorHref ?>" class="editor-link"
                <?php echo ($handler->getEditorAjax($filePath, (int) $line) ? ' data-ajax' : '') ?>>
    ...
    if ($line !== null) :
        ...
        if ($range) :
            ...
            class="code-block linenums:<?php echo $start ?>"><?php echo $tpl->escape($code) ?></pre>
        ...
        <?php if ($frameArgs): ?>
          <div class="frame-file">Arguments</div>
    ...
    ?>
        <div
            class="frame-comments <?php echo empty($comments) ? 'empty' : '' ?>">
