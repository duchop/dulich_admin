...
class VersionConstraintParserTest extends TestCase
{
    ...
    public function versionStringProvider()
    {
        return [
            ...
            [
                '~4.6',
                new AndVersionConstraintGroup('~4.6', [
            ...
            [
                '~4.6.2',
                new AndVersionConstraintGroup('~4.6.2', [
            ...
            [
                '^2.6.1',
                new AndVersionConstraintGroup('^2.6.1', [
            ...
            [
                '5.1.*',
                new SpecificMajorAndMinorVersionConstraint('5.1.*', 5, 1)
            ],
            [
                '5.*',
                new SpecificMajorVersionConstraint('5.*', 5)
            ],
            [
                '*',
            ...
            [
                '1.0.2 || 1.0.5',
                new OrVersionConstraintGroup('1.0.2 || 1.0.5', [
                    new ExactVersionConstraint('1.0.2'),
            ...
            [
                '^5.6 || ^7.0',
                new OrVersionConstraintGroup('^5.6 || ^7.0', [
                    new AndVersionConstraintGroup('^5.6', [
                        new GreaterThanOrEqualToVersionConstraint('^5.6', new Version('5.6')),
                        new SpecificMajorVersionConstraint('^5.6', 5)
                    ]),
                    new AndVersionConstraintGroup('^7.0', [
