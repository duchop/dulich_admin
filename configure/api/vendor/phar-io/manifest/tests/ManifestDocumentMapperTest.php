...
class ManifestDocumentMapperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCanSerializeToString($expected)
    {
        ...
        $this->assertInstanceOf(Manifest::class, $mapper->map($manifestDocument));
    }
    ...
    public function dataProvider()
    {
        return [
            'application' => [
                __DIR__ . '/_fixture/phpunit-5.6.5.xml'
            ],
            'library' => [
                __DIR__ . '/_fixture/library.xml'
            ],
            'extension' => [
                __DIR__ . '/_fixture/extension.xml'
            ]
        ];
    }
