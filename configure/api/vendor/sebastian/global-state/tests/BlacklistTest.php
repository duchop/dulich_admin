...
class BlacklistTest extends TestCase
{
    ...
    {
        $this->assertFalse($this->blacklist->isStaticAttributeBlacklisted(BlacklistedClass::class, 'attribute'));
    }
    ...
    public function testClassCanBeBlacklisted()
    {
        ...
        $this->assertTrue($this->blacklist->isStaticAttributeBlacklisted(BlacklistedClass::class, 'attribute'));
    }
    ...
    public function testSubclassesCanBeBlacklisted()
    {
        ...
        $this->assertTrue($this->blacklist->isStaticAttributeBlacklisted(BlacklistedChildClass::class, 'attribute'));
    }
    ...
    public function testImplementorsCanBeBlacklisted()
    {
        ...
        $this->assertTrue($this->blacklist->isStaticAttributeBlacklisted(BlacklistedImplementor::class, 'attribute'));
    }
    ...
    {
        $this->blacklist->addStaticAttribute(BlacklistedClass::class, 'attribute');
