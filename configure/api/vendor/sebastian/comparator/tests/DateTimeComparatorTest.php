...
class DateTimeComparatorTest extends TestCase
{
    ...
    {
        $this->assertTrue($this->comparator->accepts(new DateTime(), new DateTime()));
    }
    ...
    {
        $this->assertNull($this->comparator->assertEquals(new DateTime('2013-03-29 04:13:35', new DateTimeZone('America/New_York')), new DateTimeImmutable('2013-03-29 04:13:35', new DateTimeZone('America/New_York'))));
    }
}
