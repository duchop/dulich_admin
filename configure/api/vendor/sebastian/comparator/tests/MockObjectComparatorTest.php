...
class MockObjectComparatorTest extends TestCase
{
    ...
    {
        // cyclic dependencies
        $book1 = $this->getMockBuilder(Book::class)
            ->setMethods(null)
            ->getMock();
        $book1->author = $this->getMockBuilder(Author::class)
            ->setMethods(null)
            ->setConstructorArgs([
            'Terry Pratchett'
        ])
        ...
        $book2 = $this->getMockBuilder(Book::class)
            ->setMethods(null)
            ->getMock();
        $book2->author = $this->getMockBuilder(Author::class)
            ->setMethods(null)
            ->setConstructorArgs([
            'Terry Pratchett'
        ])
        ...
        $object1 = $this->getMockBuilder(SampleClass::class)
            ->setMethods(null)
            ->setConstructorArgs([
            4,
            8,
            ...
            ->getMock();
        $object2 = $this->getMockBuilder(SampleClass::class)
            ->setMethods(null)
            ->setConstructorArgs([
            4,
            8,
        ...
        return [
            ...
            [
                $this->getMockBuilder(Struct::class)
                    ->setMethods(null)
                    ->setConstructorArgs([
                    2.3
                ])
    ...
    public function assertEqualsFailsProvider()
    {
        ...
        $book3 = $this->getMockBuilder(Book::class)
            ->setMethods(null)
            ->getMock();
        ...
        return [
            [
                $this->getMockBuilder(SampleClass::class)
                    ->setMethods(null)
                    ->setConstructorArgs([
                    4,
                    8,
