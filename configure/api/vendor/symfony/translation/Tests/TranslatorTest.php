...
class TranslatorTest extends TestCase
{
    ...
    public function testGetCatalogueReturnsConsolidatedCatalogue()
    {
        ...
        $translator->addResource('loader-a', array(
            'foo' => 'foofoo'
        ), $locale, 'domain-a');
        $translator->addResource('loader-b', array(
            'bar' => 'foobar'
        ), $locale, 'domain-b');
    ...
    public function testNestedFallbackCatalogueWhenUsingMultipleLocales()
    {
        ...
        $this->assertNotNull($translator->getCatalogue('ru')
    ...
    public function testTransChoiceFallback()
    {
        ...
        $this->assertEquals('10 things', $translator->transChoice('some_message2', 10, array(
            '%count%' => 10
        )));
    }
    ...
    public function testTransChoiceFallbackWithNoTranslation()
    {
        ...
        $this->assertEquals('some_message2', $translator->transChoice('some_message2', 10, array(
            '%count%' => 10
        )));
    }
}
