...
class AddConsoleCommandPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($commandServices as $id => $tags) {
            ...
            $definition->addMethodCall('setName', array(
                $commandName
            ));
            
            if ($aliases) {
                $definition->addMethodCall('setAliases', array(
                    $aliases
                ));
            }
        }
        
        $container->register($this->commandLoaderServiceId, ContainerCommandLoader::class)
            ->setPublic(true)
            ->setArguments(array(
