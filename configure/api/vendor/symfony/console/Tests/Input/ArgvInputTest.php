...
class ArgvInputTest extends TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $this->assertEquals(array(
            'foo'
        ), $p->getValue($input), '__construct() automatically get its input from the argv server variable');
    }
    ...
    public function testParseArguments()
    {
        ...
        $this->assertEquals(array(
            'name' => 'foo'
        ), $input->getArguments(), '->parse() parses required arguments');
        ...
        $this->assertEquals(array(
            'name' => 'foo'
        ), $input->getArguments(), '->parse() is stateless');
    }
    ...
    public function testParseArrayArgument()
    {
        ...
        ), $input->getArguments(), '->parse() parses array arguments');
    }
    ...
    public function testParseArrayOption()
    {
        ...
        ), $input->getOptions(), '->parse() parses array options ("--option=value" syntax)');
        ...
        ), $input->getOptions(), '->parse() parses empty array options as null ("--option=value" syntax)');
    ...
    public function testParseNegativeNumberAfterDoubleDash()
    {
        ...
        $this->assertEquals(array(
            'number' => '-1'
        ), $input->getArguments(), '->parse() parses arguments with leading dashes as arguments after having encountered a double-dash sequence');
        ...
        $this->assertEquals(array(
            'foo' => 'bar'
        ), $input->getOptions(), '->parse() parses arguments with leading dashes as options before having encountered a double-dash sequence');
        $this->assertEquals(array(
            'number' => '-1'
        ), $input->getArguments(), '->parse() parses arguments with leading dashes as arguments after having encountered a double-dash sequence');
    }
    ...
    public function testParseEmptyStringArgument()
    {
        ...
        $this->assertEquals(array(
            'empty' => ''
        ), $input->getArguments(), '->parse() parses empty string arguments');
    }
    ...
    public function testNoWarningOnInvalidParameterOption()
    {
        ...
        $this->assertTrue($input->hasParameterOption(array(
            '-e',
            ''
        )));
        // No warning thrown
        $this->assertFalse($input->hasParameterOption(array(
            '-m',
            ''
        )));
        
        $this->assertEquals('dev', $input->getParameterOption(array(
            '-e',
            ''
        )));
        // No warning thrown
        $this->assertFalse($input->getParameterOption(array(
            '-m',
            ''
        )));
    }
    ...
    public function testParseSingleDashAsArgument()
    {
        ...
        $this->assertEquals(array(
            'file' => '-'
        ), $input->getArguments(), '->parse() parses single dash as an argument');
    }
    ...
    public function testParseOptionWithValueOptionalGivenEmptyAndRequiredArgument()
    {
        ...
        $this->assertEquals(array(
            'foo' => null
        ), $input->getOptions(), '->parse() parses optional options with empty value as null');
        $this->assertEquals(array(
            'name' => 'bar'
        ), $input->getArguments(), '->parse() parses required arguments');
    ...
    public function testParseOptionWithValueOptionalGivenEmptyAndOptionalArgument()
    {
        ...
        $this->assertEquals(array(
            'name' => 'bar'
        ), $input->getArguments(), '->parse() parses optional arguments');
