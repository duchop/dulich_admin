...
class OutputFormatterTest extends TestCase
{
    ...
    public function testLGCharEscaping()
    {
        ...
        $this->assertEquals("\033[33mSymfony\\Component\\Console does work very well!\033[39m", $formatter->format('<comment>Symfony\Component\Console does work very well!</comment>'));
    }
    ...
    public function testBundledStyles()
    {
        ...
        $this->assertEquals("\033[30;46msome question\033[39;49m", $formatter->format('<question>some question</question>'));
    }
    ...
    public function testNestedStyles()
    {
        ...
        $this->assertEquals("\033[37;41msome \033[39;49m\033[32msome info\033[39m\033[37;41m error\033[39;49m", $formatter->format('<error>some <info>some info</info> error</error>'));
    }
    ...
    public function testAdjacentStyles()
    {
        ...
        $this->assertEquals("\033[37;41msome error\033[39;49m\033[32msome info\033[39m", $formatter->format('<error>some error</error><info>some info</info>'));
    }
    ...
    public function testStyleEscaping()
    {
        ...
        $this->assertEquals("(\033[32mz>=2.0,<<<a2.3\\\033[39m)", $formatter->format('(<info>' . $formatter->escape('z>=2.0,<\\<<a2.3\\') . '</info>)'));
        
        $this->assertEquals("\033[32m<error>some error</error>\033[39m", $formatter->format('<info>' . $formatter->escape('<error>some error</error>') . '</info>'));
    }
    ...
    public function testDeepNestedStyles()
    {
        ...
        $this->assertEquals("\033[37;41merror\033[39;49m\033[32minfo\033[39m\033[33mcomment\033[39m\033[37;41merror\033[39;49m", $formatter->format('<error>error<info>info<comment>comment</info>error</error>'));
    }
    ...
    public function provideInlineStyleOptionsCases()
    {
        return array(
            ...
            array(
                '<fg=green;>',
                "\033[32m[test]\033[39m",
                '[test]'
            ),
            array(
                '<fg=green;bg=blue;>',
                "\033[32;44ma\033[39;49m",
                'a'
            ),
            array(
                '<fg=green;options=bold>',
                "\033[32;1mb\033[39;22m",
                'b'
            ),
            array(
                '<fg=green;options=reverse;>',
                "\033[32;7m<a>\033[39;27m",
                '<a>'
            ),
            array(
     ...
     * @expectedDeprecation Unknown style options are deprecated since Symfony 3.2 and will be removed in 4.0.
     * Exception "Invalid option specified: "%s". Expected one of (bold, underscore, blink, reverse, conceal)".
     */
    ...
    public function provideInlineStyleTagsWithUnknownOptions()
    {
        return array(
            ...
            array(
                '<fg=green;options=xyz;>',
                'xyz'
            ),
            array(
                '<fg=green;options=efg,abc>',
                'efg'
            )
        );
    }
    ...
    public function testNotDecoratedFormatter()
    {
        ...
        $this->assertEquals("\033[33msome comment\033[39m", $formatter->format('<comment>some comment</comment>'));
        $this->assertEquals("\033[30;46msome question\033[39;49m", $formatter->format('<question>some question</question>'));
        $this->assertEquals("\033[31msome text with inline style\033[39m", $formatter->format('<fg=red>some text with inline style</>'));
    }
