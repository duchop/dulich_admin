...
class QuestionHelperTest extends AbstractQuestionHelperTest
{
    ...
    public function testAskChoice()
    {
        ...
        $this->assertEquals(array(
            'Batman'
        ), $questionHelper->ask($this->createStreamableInputInterfaceMock($inputStream), $this->createOutputInterface(), $question));
        $this->assertEquals(array(
            'Superman',
            'Spiderman'
        ), $questionHelper->ask($this->createStreamableInputInterfaceMock($inputStream), $this->createOutputInterface(), $question));
    ...
    public function testAskWithAutocompleteWithNonSequentialKeys()
    {
        ...
        $dialog = new QuestionHelper();
        $dialog->setHelperSet(new HelperSet(array(
            new FormatterHelper()
        )));
        
        $question = new ChoiceQuestion('Please select a bundle', array(
            1 => 'AcmeDemoBundle',
            4 => 'AsseticBundle'
        ));
        $question->setMaxAttempts(1);
    ...
    public function testAutocompleteWithTrailingBackslash()
    {
        ...
        $irrelevantEscSequences = array(
            ...
            "\033[K" => ''
        ) // Clear line from cursor till the end
;
     ...
     * @expectedExceptionMessage The provided answer is ambiguous.
     * Value should be one of env_2 or env_3.
     */
    ...
    public function testTraversableAutocomplete()
    {
        ...
        $question = new Question('Please select a bundle', 'FrameworkBundle');
        $question->setAutocompleterValues(new AutocompleteValues(array(
