...
class Application
{
    ...
    {
        if (true === $input->hasParameterOption(array(
            '--version',
            '-V'
        ), true)) {
        ...
        if (! $name) {
            ...
            $definition->setArguments(array_merge($definition->getArguments(), array(
    ...
    protected function configureIO(InputInterface $input, OutputInterface $output)
    {
        ...
        } elseif (true === $input->hasParameterOption(array(
            '--no-ansi'
        ), true)) {
