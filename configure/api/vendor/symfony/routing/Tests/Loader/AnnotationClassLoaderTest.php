...
class AnnotationClassLoaderTest extends AbstractAnnotationLoaderTest
{
    ...
    public function testLoad($className, $routeData = array(), $methodArgs = array())
    {
        ...
        $this->reader->expects($this->once())
            ...
            $this->getAnnotatedRoute($routeData)
        )));
        ...
        $this->assertCount(\count($routeData['requirements']), array_intersect_assoc($routeData['requirements'], $route->getRequirements()), '->load preserves requirements annotation');
        $this->assertCount(\count($routeData['options']), array_intersect_assoc($routeData['options'], $route->getOptions()), '->load preserves options annotation');
        $this->assertCount(\count($routeData['defaults']), $route->getDefaults(), '->load preserves defaults annotation');
    ...
    public function testClassRouteLoad()
    {
        ...
        $this->reader->expects($this->once())
            ->method('getMethodAnnotations')
            ->will($this->returnValue(array(
            $this->getAnnotatedRoute($methodRouteData)
        )));
    ...
    public function testInvokableClassRouteLoad()
    {
        ...
        $this->reader->expects($this->exactly(1))
            ...
            ->will($this->returnValue(array(
            $this->getAnnotatedRoute($classRouteData)
        )));
        $this->reader->expects($this->once())
            ->method('getMethodAnnotations')
            ->will($this->returnValue(array()));
    ...
    public function testInvokableClassMultipleRouteLoad()
    {
        ...
        $this->reader->expects($this->exactly(1))
            ->method('getClassAnnotations')
            ->will($this->returnValue(array(
            $this->getAnnotatedRoute($classRouteData1),
            $this->getAnnotatedRoute($classRouteData2)
        )));
        $this->reader->expects($this->once())
            ->method('getMethodAnnotations')
            ->will($this->returnValue(array()));
