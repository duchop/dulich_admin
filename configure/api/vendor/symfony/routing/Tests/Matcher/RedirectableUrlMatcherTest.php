...
class RedirectableUrlMatcherTest extends UrlMatcherTest
{
    ...
    {
        $coll = new RouteCollection();
        $coll->add('foo', new Route('/foo/{bar}', array(), array(), array(), '', array(
            'https'
        )));
    ...
    {
        return $this->getMockForAbstractClass('Symfony\Component\Routing\Matcher\RedirectableUrlMatcher', array(
            $routes,
            $context ?  : new RequestContext()
        ));
    }
