    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/foo')) {
            ...
            if (preg_match('#^/foo/(?P<bar>baz|symfony)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array(
                    '_route' => 'foo'
                )), array(
                    'def' => 'test'
                ));
        ...
        elseif (0 === strpos($pathinfo, '/bar')) {
            ...
            if (preg_match('#^/bar/(?P<foo>[^/]++)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array(
                    '_route' => 'bar'
                )), array());
                if (! in_array($canonicalMethod, array(
                    'GET',
                    'HEAD'
                ))) {
        ...
        elseif (0 === strpos($pathinfo, '/test')) {
            ...
            if (preg_match('#^/test/(?P<foo>[^/]++)/$#sD', $pathinfo, $matches)) {
                ...
                if (! in_array($requestMethod, array(
                    'POST'
                ))) {
                    $allow = array_merge($allow, array(
                        'POST'
        ...
        if (preg_match('#^(?P<var1>[^\\.]++)\\.example\\.com$#sDi', $host, $hostMatches)) {
            if (0 === strpos($pathinfo, '/route1')) {
                // route11
                if ('/route11' === $pathinfo) {
                    return $this->mergeDefaults(array_replace($hostMatches, array(
                        '_route' => 'route11'
                    )), array());
                }
                ...
                if (0 === strpos($pathinfo, '/route13') && preg_match('#^/route13/(?P<name>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($hostMatches, $matches, array(
                        '_route' => 'route13'
                    )), array());
                }
