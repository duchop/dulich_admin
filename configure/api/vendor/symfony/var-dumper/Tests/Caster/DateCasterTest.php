...
EODUMP;
    ...
    public function testCastDateTime($time, $timezone, $xDate, $xTimestamp, $xInfos)
    {
        ...
        $stub = new Stub();
        $date = new \DateTime($time, new \DateTimeZone($timezone));
        $cast = DateCaster::castDateTime($date, array(
            'foo' => 'bar'
        ), $stub, false, 0);
...
EODUMP;
    ...
    public function testCastInterval($intervalSpec, $ms, $invert, $xInterval, $xSeconds)
    {
        ...
        $cast = DateCaster::castInterval($interval, array(
            'foo' => 'bar'
        ), $stub, false, Caster::EXCLUDE_VERBOSE);
...
EODUMP;
    ...
    public function testCastTimeZone($timezone, $xTimezone, $xRegion)
    {
        ...
        $cast = DateCaster::castTimeZone($timezone, array(
            'foo' => 'bar'
        ), $stub, false, Caster::EXCLUDE_VERBOSE);
...
EODUMP;
    ...
    public function provideTimeZones()
    {
        ...
        return array(
            ...
            array(
                'Atlantic/Canary',
                'Atlantic/Canary (%s:00)',
                $xRegion
            ),
            array(
                'Australia/Perth',
                'Australia/Perth (%s:00)',
                $xRegion
            ),
            array(
                'Europe/Zurich',
    ...
    public function providePeriods()
    {
        ...
        $periods = array(
            ...
            array(
                ...
                '2017-01-03',
                0,
                "every + 1d 01:00:00$ms, from 2017-01-01 00:00:00.0 (included) to 2017-01-03 00:00:00.0",
            ...
            array(
                ...
                1,
                0,
                "every + 1d 01:00:00$ms, from 2017-01-01 00:00:00.0 (included) recurring 2 time/s",
                '1) 2017-01-01 00:00:00.0%a2) 2017-01-02 01:00:00.0'
            ),
