...
abstract class AbstractCloner implements ClonerInterface
{
    ...
    /**
     * Sets the minimum tree depth where we are guaranteed to clone all the items.
     * After this
