...
abstract class AbstractSurrogateFragmentRenderer extends RoutableFragmentRenderer
{
     ...
     *            An Surrogate instance
     * @param FragmentRendererInterface $inlineStrategy
    ...
    /**
     *
     * {@inheritdoc} Note that if the current Request has no surrogate capability, this method
