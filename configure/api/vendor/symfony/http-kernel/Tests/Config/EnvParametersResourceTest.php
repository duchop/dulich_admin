...
class EnvParametersResourceTest extends TestCase
{
    ...
    public function testGetResource()
    {
        ...
        ), $this->resource->getResource(), '->getResource() returns the resource');
    }

    public function testToString()
    {
        $this->assertSame(serialize(array(
            'prefix' => $this->prefix,
            'variables' => $this->initialEnv
    ...
    {
        $this->assertTrue($this->resource->isFresh(time()), '->isFresh() returns true if the variables have not changed');
    }
    ...
    public function testIsFreshValueChanged()
    {
        ...
        $this->assertFalse($this->resource->isFresh(time()), '->isFresh() returns false if a variable has been changed');
    }
    ...
    public function testIsFreshValueRemoved()
    {
        ...
        $this->assertFalse($this->resource->isFresh(time()), '->isFresh() returns false if a variable has been removed');
    }
    ...
    public function testIsFreshValueAdded()
    {
        ...
        $this->assertFalse($this->resource->isFresh(time()), '->isFresh() returns false if a variable has been added');
    }
