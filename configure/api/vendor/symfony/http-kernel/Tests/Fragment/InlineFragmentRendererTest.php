...
class InlineFragmentRendererTest extends TestCase
{
    ...
    public function testRender()
    {
        ...
        $this->assertEquals('foo', $strategy->render('/', Request::create('/'))
            ->getContent());
    }
    ...
    public function testRenderWithControllerReference()
    {
        ...
        $this->assertEquals('foo', $strategy->render(new ControllerReference('main_controller', array(), array()), Request::create('/'))
            ->getContent());
    }
    ...
    public function testRenderWithObjectsAsAttributes()
    {
        ...
        $subRequest->headers->set('x-forwarded-for', array(
            '127.0.0.1'
        ));
        $subRequest->headers->set('forwarded', array(
        ...
        $this->assertSame('foo', $strategy->render(new ControllerReference('main_controller', array(
            'object' => $object
    ...
    {
        $resolver = $this->getMockBuilder('Symfony\\Component\\HttpKernel\\Controller\\ControllerResolver')
            ->setMethods(array(
            'getController'
        ))
            ->getMock();
        ...
        $response = $renderer->render(new ControllerReference('main_controller', array(
            'object' => new \stdClass(),
            'object1' => new Bar()
        ), array()), Request::create('/'));
    ...
    public function testRenderWithTrustedHeaderDisabled()
    {
        ...
        $expectedSubRequest->headers->set('x-forwarded-for', array(
            '127.0.0.1'
        ));
        $expectedSubRequest->server->set('HTTP_X_FORWARDED_FOR', '127.0.0.1');
        
        $strategy = new InlineFragmentRenderer($this->getKernelExpectingRequest($expectedSubRequest));
        $this->assertSame('foo', $strategy->render('/', Request::create('/'))
            ->getContent());
    ...
    public function testRenderExceptionIgnoreErrors()
    {
        ...
        $this->assertEmpty($strategy->render('/', Request::create('/'), array(
            'ignore_errors' => true
        ))
            ->getContent());
    }
    ...
    {
        $strategy = new InlineFragmentRenderer($this->getKernel($this->onConsecutiveCalls($this->throwException(new \RuntimeException('foo')), $this->returnValue(new Response('bar')))));
        
        $this->assertEquals('bar', $strategy->render('/', Request::create('/'), array(
            'ignore_errors' => true,
            'alt' => '/foo'
        ))
            ->getContent());
    ...
    public function testExceptionInSubRequestsDoesNotMangleOutputBuffers()
    {
        ...
        $renderer->render('/', Request::create('/'), array(
            'ignore_errors' => true
        ));
    ...
    public function testLocaleAndFormatAreIsKeptInSubrequest()
    {
        ...
        $expectedSubRequest->headers->set('forwarded', array(
            'for="127.0.0.1";host="localhost";proto=http'
        ));
