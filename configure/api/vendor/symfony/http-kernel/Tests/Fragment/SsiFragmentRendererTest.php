...
class SsiFragmentRendererTest extends TestCase
{
    ...
    public function testRender()
    {
        ...
        $this->assertEquals('<!--#include virtual="/" -->', $strategy->render('/', $request)
            ->getContent());
        $this->assertEquals('<!--#include virtual="/" -->', $strategy->render('/', $request, array(
    ...
    public function testRenderControllerReference()
    {
        ...
        $this->assertEquals('<!--#include virtual="/_fragment?_path=_format%3Dhtml%26_locale%3Dfr%26_controller%3Dmain_controller&_hash=Jz1P8NErmhKTeI6onI1EdAXTB85359MY3RIk5mSJ60w%3D" -->', $strategy->render($reference, $request, array(
            'alt' => $altReference
        ))
            ->getContent());
    }
