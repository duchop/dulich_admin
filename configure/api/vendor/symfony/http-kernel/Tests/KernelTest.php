...
class KernelTest extends TestCase
{
    ...
    public function testBootSetsTheBootedFlagToTrue()
    {
        ...
        $kernel = $this->getKernelForTest(array(
            'initializeBundles',
            'initializeContainer'
        ));
        $kernel->boot();
    ...
    public function testShutdownCallsShutdownOnAllBundles()
    {
        ...
        $kernel = $this->getKernel(array(), array(
            $bundle
        ));
    ...
    public function testHandleCallsHandleOnHttpKernel()
    {
        ...
        $httpKernelMock = $this->getMockBuilder('Symfony\Component\HttpKernel\HttpKernel')
            ->disableOriginalConstructor()
            ->getMock();
        $httpKernelMock->expects($this->once())
            ->method('handle')
...
EOF;
    ...
    public function testLocateResourceIgnoresDirOnNonResource()
    {
        ...
        $this->assertEquals(__DIR__ . '/Fixtures/Bundle1Bundle/foo.txt', $kernel->locateResource('@Bundle1Bundle/foo.txt', __DIR__ . '/Fixtures'));
    }
    ...
    public function testLocateResourceReturnsTheDirOneForResources()
    {
        ...
        $kernel->expects($this->once())
            ->method('getBundle')
            ->will($this->returnValue(array(
            $this->getBundle(__DIR__ . '/Fixtures/FooBundle', null, null, 'FooBundle')
        )));
        
        $this->assertEquals(__DIR__ . '/Fixtures/Resources/FooBundle/foo.txt', $kernel->locateResource('@FooBundle/Resources/foo.txt', __DIR__ . '/Fixtures/Resources'));
    }
    ...
    public function testLocateResourceReturnsTheDirOneForResourcesAndBundleOnes()
    {
        ...
        $kernel->expects($this->once())
            ->method('getBundle')
            ->will($this->returnValue(array(
            $this->getBundle(__DIR__ . '/Fixtures/Bundle1Bundle', null, null, 'Bundle1Bundle')
        )));
    ...
    public function testLocateResourceOnDirectories()
    {
        ...
        $this->assertEquals(__DIR__ . '/Fixtures/Resources/FooBundle/', $kernel->locateResource('@FooBundle/Resources/', __DIR__ . '/Fixtures/Resources'));
        $this->assertEquals(__DIR__ . '/Fixtures/Resources/FooBundle', $kernel->locateResource('@FooBundle/Resources', __DIR__ . '/Fixtures/Resources'));
        ...
        $this->assertEquals(__DIR__ . '/Fixtures/Bundle1Bundle/Resources/', $kernel->locateResource('@Bundle1Bundle/Resources/'));
        $this->assertEquals(__DIR__ . '/Fixtures/Bundle1Bundle/Resources', $kernel->locateResource('@Bundle1Bundle/Resources'));
    }
    ...
    public function testKernelWithoutBundles()
    {
        ...
        $this->assertTrue($kernel->getContainer()
            ->getParameter('test_executed'));
    }
    ...
    /**
     * @group legacy
     * @expectedDeprecation The "Symfony\Component\HttpKernel\Kernel::getEnvParameters()" method is deprecated as of 3.3 and will be removed in 4.0.
     * Use the %cenv()%c syntax to get the value of any environment variable from configuration files instead.
    ...
    public function testProjectDirExtension()
    {
        ...
        $this->assertSame('foo', $kernel->getContainer()
    ...
    public function testServicesResetter()
    {
        $httpKernelMock = $this->getMockBuilder(HttpKernelInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
        $httpKernelMock->expects($this->exactly(2))
            ->method('handle');
        ...
        $this->assertFalse($kernel->getContainer()
            ->initialized('services_resetter'));
