...
class ArgumentResolverTest extends TestCase
{
    ...
    public function testDefaultState()
    {
        ...
        $this->assertNotEquals(self::$resolver, new ArgumentResolver(null, array(
    ...
    public function testGetArguments()
    {
        ...
        $this->assertEquals(array(
            'foo'
        ), self::$resolver->getArguments($request, $controller), '->getArguments() returns an array of arguments for the controller method');
    }
    ...
    public function testGetArgumentsUsesDefaultValue()
    {
        ...
        $this->assertEquals(array(
            'foo',
            null
        ), self::$resolver->getArguments($request, $controller), '->getArguments() uses default values if present');
    }
    ...
    public function testGetArgumentsOverrideDefaultValueByRequestAttribute()
    {
        ...
        $this->assertEquals(array(
            'foo',
            'bar'
        ), self::$resolver->getArguments($request, $controller), '->getArguments() overrides default values if provided in the request attributes');
    }
    ...
    public function testGetArgumentsInjectsRequest()
    {
        ...
        $controller = array(
            new self(),
            'controllerWithRequest'
        );
        
        $this->assertEquals(array(
            $request
        ), self::$resolver->getArguments($request, $controller), '->getArguments() injects the request');
    }
    ...
    public function testGetArgumentsInjectsExtendingRequest()
    {
        ...
        $controller = array(
            new self(),
            'controllerWithExtendingRequest'
        );
        
        $this->assertEquals(array(
            $request
        ), self::$resolver->getArguments($request, $controller), '->getArguments() injects the request when extended');
    }
    ...
    public function testGetArgumentWithoutArray()
    {
        ...
        $resolver = new ArgumentResolver($factory, array(
            $valueResolver
        ));
        
        $valueResolver->expects($this->any())
            ->method('supports')
            ->willReturn(true);
        $valueResolver->expects($this->any())
            ->method('resolve')
