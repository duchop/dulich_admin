...
class ContainerControllerResolverTest extends ControllerResolverTest
{
    ...
    public function testNonInstantiableController()
    {
        ...
        $request->attributes->set('_controller', array(
            NonInstantiableController::class,
            'action'
        ));
     ...
     * @expectedExceptionMessage Controller "Symfony\Component\HttpKernel\Tests\Controller\ImpossibleConstructController" cannot be fetched from the container because it is private.
    ...
    public function testNonConstructController()
    {
        ...
        $container->expects($this->atLeastOnce())
            ...
            ImpossibleConstructController::class => true
        )));
        
        $resolver = $this->createControllerResolver(null, $container);
        $request = Request::create('/');
        $request->attributes->set('_controller', array(
            ImpossibleConstructController::class,
            'action'
        ));
    ...
    /**
     * @expectedException \LogicException
     * @expectedExceptionMessage Controller "app.my_controller" cannot be fetched from the container because it is private.
     * Did you forget to tag the service with "controller.service_arguments"?
     */
    ...
    /**
     * @expectedException \LogicException
     * @expectedExceptionMessage Controller "app.my_controller" cannot be called without a method name.
     * Did you forget an "__invoke" method?
     */
    ...
    public function getUndefinedControllers()
    {
        return array(
            array(
                ...
                '/Controller not found: service "foo" does not exist\./'
            ),
            array(
                'oof::bar',
            ...
            array(
                'stdClass',
                \LogicException::class,
                '/Controller not found: service "stdClass" does not exist\./'
            ),
            array(
