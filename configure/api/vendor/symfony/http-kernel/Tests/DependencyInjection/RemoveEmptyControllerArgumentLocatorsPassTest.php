...
class RemoveEmptyControllerArgumentLocatorsPassTest extends TestCase
{
    ...
    public function testProcess()
    {
        ...
        $container->register('c2', RemoveTestController2::class)
            ->addTag('controller.service_arguments')
            ->addMethodCall('setTestCase', array(
            new Reference('c1')
        ));
        ...
        $controllers = $container->getDefinition((string) $resolver->getArgument(0))
            ->getArgument(0);
        
        $this->assertCount(2, $container->getDefinition((string) $controllers['c1:fooAction']->getValues()[0])
            ->getArgument(0));
        $this->assertCount(1, $container->getDefinition((string) $controllers['c2:setTestCase']->getValues()[0])
            ->getArgument(0));
        $this->assertCount(1, $container->getDefinition((string) $controllers['c2:fooAction']->getValues()[0])
            ->getArgument(0));
        ...
        $this->assertCount(1, $container->getDefinition((string) $controllers['c2:setTestCase']->getValues()[0])
            ->getArgument(0));
        $this->assertSame(array(), $container->getDefinition((string) $controllers['c2:fooAction']->getValues()[0])
            ->getArgument(0));
        ...
        $this->assertSame(array(
            'bar'
        ), array_keys($container->getDefinition((string) $controllers['c1:fooAction']->getValues()[0])
            ->getArgument(0)));
        ...
        $this->assertSame($expectedLog, $container->getCompiler()
            ->getLog());
    }
    ...
    public function testSameIdClass()
    {
        ...
        $container->register(RegisterTestController::class, RegisterTestController::class)->addTag('controller.service_arguments');
        ...
        $this->assertEquals($expected, array_keys($container->getDefinition((string) $resolver->getArgument(0))
            ->getArgument(0)));
    }
    ...
    public function testInvoke()
    {
        ...
        $container->register('invokable', InvokableRegisterTestController::class)->addTag('controller.service_arguments');
        ...
        $this->assertEquals(array(
            'invokable:__invoke',
            'invokable'
        ), array_keys($container->getDefinition((string) $resolver->getArgument(0))
            ->getArgument(0)));
    }
    ...
    public function testInvokeSameIdClass()
    {
        ...
        $container->register(InvokableRegisterTestController::class, InvokableRegisterTestController::class)->addTag('controller.service_arguments');
