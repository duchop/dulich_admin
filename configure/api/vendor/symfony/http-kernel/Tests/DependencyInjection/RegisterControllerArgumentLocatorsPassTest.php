...
class RegisterControllerArgumentLocatorsPassTest extends TestCase
{
    ...
    public function testInvalidClass()
    {
        ...
        $container->register('foo', NotFound::class)->addTag('controller.service_arguments');
    ...
    public function testNoAction()
    {
        ...
        $container->register('foo', RegisterTestController::class)->addTag('controller.service_arguments', array(
            'argument' => 'bar'
        ));
    ...
    public function testAllActions()
    {
        ...
        $container->register('foo', RegisterTestController::class)->addTag('controller.service_arguments');
        
        $pass = new RegisterControllerArgumentLocatorsPass();
        $pass->process($container);
        
        $locator = $container->getDefinition((string) $resolver->getArgument(0))
            ->getArgument(0);
        ...
        $expected = array(
            'bar' => new ServiceClosureArgument(new TypedReference(ControllerDummy::class, ControllerDummy::class, RegisterTestController::class, ContainerInterface::IGNORE_ON_INVALID_REFERENCE))
        );
    ...
    public function testExplicitArgument()
    {
        ...
        $container->register('foo', RegisterTestController::class)
            ->addTag('controller.service_arguments', array(
            'action' => 'fooAction',
            'argument' => 'bar',
            'id' => 'bar'
        ))
            ...
            'argument' => 'bar',
            'id' => 'baz'
        )); // should be ignored, the first wins
        ...
        $expected = array(
            'bar' => new ServiceClosureArgument(new TypedReference('bar', ControllerDummy::class, RegisterTestController::class))
        );
        $this->assertEquals($expected, $locator->getArgument(0));
    }
    ...
    public function testOptionalArgument()
    {
        ...
        $expected = array(
            'bar' => new ServiceClosureArgument(new TypedReference('bar', ControllerDummy::class, RegisterTestController::class, ContainerInterface::IGNORE_ON_INVALID_REFERENCE))
        );
        $this->assertEquals($expected, $locator->getArgument(0));
    }
    ...
    public function testSkipSetContainer()
    {
        ...
        $container->register('foo', ContainerAwareRegisterTestController::class)->addTag('controller.service_arguments');
    ...
    public function testExceptionOnNonExistentTypeHint()
    {
        ...
        $container->register('foo', NonExistentClassController::class)->addTag('controller.service_arguments');
    ...
    public function testExceptionOnNonExistentTypeHintDifferentNamespace()
    {
        ...
        $container->register('foo', NonExistentClassDifferentNamespaceController::class)->addTag('controller.service_arguments');
    ...
    public function testNoExceptionOnNonExistentTypeHintOptionalArg()
    {
        ...
        $container->register('foo', NonExistentClassOptionalController::class)->addTag('controller.service_arguments');
    ...
    public function testArgumentWithNoTypeHintIsOk()
    {
        ...
        $container->register('foo', ArgumentWithoutTypeController::class)->addTag('controller.service_arguments');
    ...
    public function testControllersAreMadePublic()
    {
        ...
        $this->assertTrue($container->getDefinition('foo')
            ->isPublic());
    }
    ...
    public function testBindingsOnChildDefinitions()
    {
        ...
        $container->setDefinition('child', (new ChildDefinition('parent'))->setBindings(array(
            '$someArg' => new Reference('parent')
        ))
            ->addTag('controller.service_arguments'));
