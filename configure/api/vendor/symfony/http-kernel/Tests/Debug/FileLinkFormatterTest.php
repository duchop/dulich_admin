...
class FileLinkFormatterTest extends TestCase
{
    ...
    public function testWhenNoFileLinkFormatAndRequest()
    {
        ...
        $request->server->set('SCRIPT_NAME', '/index.blade.php');
        $request->server->set('SCRIPT_FILENAME', '/public/index.blade.php');
        $request->server->set('REQUEST_URI', '/index.blade.php/example');
