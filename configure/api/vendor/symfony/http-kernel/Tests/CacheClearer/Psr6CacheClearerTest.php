...
class Psr6CacheClearerTest extends TestCase
{
    ...
    /**
     * @group legacy
     * @expectedDeprecation The Symfony\Component\HttpKernel\CacheClearer\Psr6CacheClearer::addPool() method is deprecated since Symfony 3.3 and will be removed in 4.0.
     * Pass an array of pools indexed by name to the constructor instead.
     */
    public function testClearPoolsInjectedByAdder()
    {
        ...
        $clearer = new Psr6CacheClearer(array(
            'pool1' => $pool1
        ));
