...
class FileProfilerStorageTest extends TestCase
{
    ...
    public function testStoreDuplicateToken()
    {
        ...
        $this->assertEquals('http://example.net/', $this->storage->read('token')
    ...
    public function testStatusCode()
    {
        ...
        $this->assertContains($tokens[0]['status_code'], array(
            200,
            404
        ));
        $this->assertContains($tokens[1]['status_code'], array(
            200,
            404
        ));
    }
