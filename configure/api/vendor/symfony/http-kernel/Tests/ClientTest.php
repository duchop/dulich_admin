...
class ClientTest extends TestCase
{
    ...
    public function testDoRequest()
    {
        ...
        $client->request('GET', '/');
        $this->assertEquals('Request: /', $client->getResponse()
        ...
        $this->assertEquals('Request: /', $client->getResponse()
            ->getContent(), '->doRequest() uses the request handler to make the request');
        $this->assertEquals('www.example.com', $client->getRequest()
        ...
        $this->assertEquals('http://www.example.com/?parameter=' . urlencode('http://google.com'), $client->getRequest()
    ...
    public function testUploadedFile()
    {
        ...
        foreach ($files as $file) {
            $client->request('POST', '/', array(), array(
                'foo' => $file
            ));
