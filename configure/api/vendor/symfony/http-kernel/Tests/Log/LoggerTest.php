...
class LoggerTest extends TestCase
{
    ...
    {
        $this->logger->{$level}($message, array(
            'user' => 'Bob'
        ));
    ...
    public function testLogLevelDisabled()
    {
        ...
        $this->logger->debug('test', array(
            'user' => 'Bob'
        ));
        $this->logger->log(LogLevel::DEBUG, 'test', array(
            'user' => 'Bob'
        ));
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock(DummyTest::class, array(
                '__toString'
            ));
        } else {
            $dummy = $this->getMock(DummyTest::class, array(
                '__toString'
            ));
        }
    ...
    {
        $logger = $this->logger;
        $logger->warning('Random message', array(
            'exception' => 'oops'
        ));
    ...
    public function testFormatter()
    {
        ...
        $this->logger->error('An error', array(
            'foo' => 'bar'
        ));
        $this->logger->warning('A warning', array(
            'baz' => 'bar'
        ));
