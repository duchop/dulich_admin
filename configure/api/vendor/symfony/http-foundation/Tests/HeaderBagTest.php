...
class HeaderBagTest extends TestCase
{
    ...
    public function testAll()
    {
        ...
        ), $bag->all(), '->all() gets all the input');
        ...
        ), $bag->all(), '->all() gets all the input key are lower case');
    }
    ...
    public function testReplace()
    {
        ...
        ), $bag->all(), '->replace() replaces the input with the argument');
    ...
    public function testGet()
    {
        ...
        $this->assertEquals(array(
            'bar'
        ), $bag->get('foo', 'nope', false), '->get return the value as array');
        ...
        $this->assertEquals(array(
            'default'
        ), $bag->get('none', 'default', false), '->get unknown values returns default as array');
        ...
        $this->assertEquals(array(
            'bar',
            'bor'
        ), $bag->get('foo', 'nope', false), '->get return all values as array');
    }
    ...
    public function testSetAssociativeArray()
    {
        ...
        $this->assertEquals(array(
            'value'
        ), $bag->get('foo', 'nope', false), 'assoc indices of multi-valued headers are ignored');
    }
