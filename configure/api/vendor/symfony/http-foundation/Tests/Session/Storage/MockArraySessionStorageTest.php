...
class MockArraySessionStorageTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->data = array(
            $this->attributes->getStorageKey() => array(
                'foo' => 'bar'
            ),
            $this->flashes->getStorageKey() => array(
                'notice' => 'hello'
            )
        );
    ...
    public function testRegenerate()
    {
        ...
        $this->assertEquals(array(
            'foo' => 'bar'
        ), $this->storage->getBag('attributes')
            ->all());
        $this->assertEquals(array(
            'notice' => 'hello'
        ), $this->storage->getBag('flashes')
            ->peekAll());
    ...
    public function testClearClearsBags()
    {
        ...
        $this->assertSame(array(), $this->storage->getBag('attributes')
            ->all());
        $this->assertSame(array(), $this->storage->getBag('flashes')
            ->peekAll());
    }
