...
class RequestTest extends TestCase
{
    ...
    public function testInitialize()
    {
        ...
        $request->initialize(array(), array(
            'foo' => 'bar'
        ));
        $this->assertEquals('bar', $request->request->get('foo'), '->initialize() takes an array of request parameters as its second argument');
        
        $request->initialize(array(), array(), array(
            'foo' => 'bar'
        ));
    ...
    public function testDuplicate()
    {
        ...
        $this->assertEquals(array(
            'foo' => 'foobar'
        ), $dup->query->all(), '->duplicate() overrides the query parameters if provided');
        $this->assertEquals(array(
            'foo' => 'foobar'
        ), $dup->request->all(), '->duplicate() overrides the request parameters if provided');
        $this->assertEquals(array(
            'foo' => 'foobar'
        ), $dup->attributes->all(), '->duplicate() overrides the attributes if provided');
        $this->assertEquals(array(
            'foo' => array(
                'foobar'
            )
        ), $dup->headers->all(), '->duplicate() overrides the HTTP header if provided');
    }
    ...
    public function testGetSetMethod()
    {
        ...
        $request = new Request();
        $request->setMethod('POST');
        $request->query->set('_method', array(
            'delete',
            'patch'
        ));
    ...
    public function testCreateFromGlobals($method)
    {
        ...
        $this->assertEquals(array(
            'bar4'
        ), $request->files->get('foo4'), '::fromGlobals() uses values from $_FILES');
    ...
    public function testGetPreferredLanguage()
    {
        ...
        $this->assertEquals('fr', $request->getPreferredLanguage(array(
            'fr'
        )));
        $this->assertEquals('fr', $request->getPreferredLanguage(array(
            'fr',
        ...
        $this->assertEquals('en', $request->getPreferredLanguage(array(
            'en',
            'fr'
        )));
        $this->assertEquals('fr-ch', $request->getPreferredLanguage(array(
            'fr-ch',
            'fr-fr'
        )));
    ...
    public function testGetLanguages()
    {
        ...
        $this->assertEquals(array(
            ...
            'en',
            'en_US'
        ), $request->getLanguages()); // Test out of order qvalues
        ...
        $this->assertEquals(array(
            ...
            'en',
            'en_US'
        ), $request->getLanguages()); // Test equal weighting without qvalues
        ...
        $this->assertEquals(array(
            ...
            'zh',
            'en_US'
        ), $request->getLanguages()); // Test equal weighting with qvalues
    ...
    /**
     * @group legacy
     * @expectedDeprecation The "Symfony\Component\HttpFoundation\Request::setTrustedHeaderName()" method is deprecated since Symfony 3.3 and will be removed in 4.0.
     * Use the $trustedHeaderSet argument of the Request::setTrustedProxies() method instead.
     */
    ...
    /**
     * @group legacy
     * @expectedDeprecation Checking only for cacheable HTTP methods with Symfony\Component\HttpFoundation\Request::isMethodSafe() is deprecated since Symfony 3.2 and will throw an exception in 4.0.
    ...
    {
        return array(
            'untrusted without via' => array(
                'HTTP/2.0',
                false,
                '',
                'HTTP/2.0'
            ),
            'untrusted with via' => array(
                'HTTP/2.0',
                false,
                '1.0 fred, 1.1 nowhere.com (Apache/1.1)',
                'HTTP/2.0'
            ),
            'trusted without via' => array(
                'HTTP/2.0',
                true,
                '',
                'HTTP/2.0'
            ),
            'trusted with via' => array(
                'HTTP/2.0',
                true,
                '1.0 fred, 1.1 nowhere.com (Apache/1.1)',
                'HTTP/1.0'
            ),
            'trusted with via and protocol name' => array(
                'HTTP/2.0',
                true,
                'HTTP/1.0 fred, HTTP/1.1 nowhere.com (Apache/1.1)',
                'HTTP/1.0'
            ),
            'trusted with broken via' => array(
                'HTTP/2.0',
                true,
                'HTTP/1^0 foo',
                'HTTP/2.0'
            ),
            'trusted with partially-broken via' => array(
                'HTTP/2.0',
                true,
                '1.0 fred, foo',
                'HTTP/1.0'
