...
class ProcessBuilderTest extends TestCase
{
    ...
    {
        $proc = ProcessBuilder::create()->add('foo')->getProcess();
    ...
    {
        $process = ProcessBuilder::create()->setPrefix('/usr/bin/php')->getProcess();
