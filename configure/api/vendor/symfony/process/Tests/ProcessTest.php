...
class ProcessTest extends TestCase
{
    ...
    /**
     * @group legacy
     * @expectedDeprecation The provided cwd does not exist.
     * Command is currently ran against getcwd(). This behavior is deprecated since Symfony 3.4 and will be removed in 4.0.
     */
    ...
    public function testTTYCommand()
    {
        ...
        $process = $this->getProcess('echo "foo" >> /dev/null && ' . $this->getProcessForCode('usleep(100000);')
            ->getCommandLine());
        $process->setTty(true);
        $process->start();
    ...
    {
        $process = $this->getProcessForCode('echo serialize($_SERVER);', null, array(
            'BAR' => 'BAZ',
            'EMPTY' => ''
        ));
...
EOTXT;
    ...
    {
        return $this->getProcess(array(
            self::$phpBin,
            '-r',
            $code
        ), $cwd, $env, $input, $timeout);
    }
