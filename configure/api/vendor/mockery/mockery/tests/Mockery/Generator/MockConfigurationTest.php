...
class MockConfigurationTest extends TestCase
{
    ...
    {
        $config = new MockConfiguration(array(
            "Mockery\Generator\\TestSubject"
        ), array(
            "foo"
        ));
    ...
    {
        $config = new MockConfiguration(array(
            "Mockery\Generator\\ClassWithFinalMethod"
        ));
    ...
    {
        $config = new MockConfiguration(array(
            "Mockery\\Generator\\TestInterface",
            "Mockery\\Generator\\TestInterface2"
        ));
        $methods = $config->getMethodsToMock();
    ...
    {
        $config = new MockConfiguration(array(
            "Mockery\Generator\TestTraversableInterface"
        ));
    ...
    {
        $config = new MockConfiguration(array(
            "Mockery\Generator\TestTraversableInterface2"
        ));
    ...
    {
        $config = new MockConfiguration(array(
            "Mockery\Generator\TestTraversableInterface3"
        ));
