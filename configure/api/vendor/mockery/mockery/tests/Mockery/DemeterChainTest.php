...
class DemeterChainTest extends MockeryTestCase
{
    ...
    public function testTwoChains()
    {
        ...
        $this->assertEquals('something', $this->mock->getElement()
            ->getFirst());
        $this->assertEquals('somethingElse', $this->mock->getElement()
            ->getSecond());
        $this->mock->mockery_getContainer()->mockery_close();
    }
    ...
    public function testThreeChains()
    {
        ...
        $this->assertEquals('somethingNew', $this->mock->getElement()
            ->getFirst());
    }
    ...
    public function testTwoNotRelatedChains()
    {
        ...
        $this->assertEquals('somethingElse', $this->mock->getOtherElement()
            ->getSecond());
        $this->assertEquals('something', $this->mock->getElement()
            ->getFirst());
    }
    ...
    public function testMultiLevelDemeterChain()
    {
        ...
        $this->assertEquals('second', $this->mock->levelOne()
            ->levelTwo()
            ->getSecond());
        $this->assertEquals('first', $this->mock->levelOne()
            ->levelTwo()
            ->getFirst());
    }
    ...
    public function testSimilarDemeterChainsOnDifferentClasses()
    {
        ...
        $this->assertEquals(1, mock1::select()->some()
            ->data());
        $this->assertEquals(2, mock1::select()->some()
            ->other()
            ->data());
        $this->assertEquals(3, mock2::select()->some()
            ->data());
        $this->assertEquals(4, mock2::select()->some()
            ->other()
            ->data());
    }
