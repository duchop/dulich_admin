...
class Configuration
{
     ...
     * i.e.
     * when method expectations are made, set using a zeroOrMoreTimes()
    ...
    /**
     * Boolean assertion is reflection caching enabled or not.
     * It should be
    ...
    /**
     *
     * @deprecated Set boolean to allow/prevent unnecessary mocking of methods
     *            
     * @param bool $flag            
     */
