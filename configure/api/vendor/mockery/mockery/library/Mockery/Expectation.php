...
class Expectation implements ExpectationInterface
{
    ...
    /**
     * Verify the current call, i.e.
     * that the given arguments match those
     * of this expectation
     *
     * @param array $args            
     * @return mixed
    ...
    private function throwAsNecessary($return)
    {
        ...
        $type = version_compare(PHP_VERSION, '7.0.0') >= 0 ? "\Throwable" : "\Exception";
    ...
    public function validateOrder()
    {
        ...
        if ($this->_globalOrderNumber) {
            $this->_mock->mockery_getContainer()->mockery_validateOrder((string) $this, $this->_globalOrderNumber, $this->_mock);
        }
    }
    ...
    {
        $this->_expectedArgs = [
            new MultiArgumentClosure($closure)
        ];
        return $this;
    }
     ...
     * values.
     * The arguments passed to the expected method are passed to the
    ...
    /**
     * Return null.
     * This is merely a language construct for Mock describing.
     *
     * @return self
     */
    ...
    /**
     * Alias to andSet().
     * Allows the natural English construct
