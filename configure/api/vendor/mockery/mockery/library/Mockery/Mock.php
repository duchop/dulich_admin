...
class Mock implements MockInterface
{
     ...
     * does not exist.
     * This implements a simple partial mock proxy system.
     *
     * @var object
     */
    ...
    /**
     * Flag to indicate we should ignore all expectations temporarily.
     * Used
    ...
    public function shouldReceive(...$methodNames)
    {
        ...
        $lastExpectation = \Mockery::parseShouldReturnArgs($this, $methodNames, function ($method) use($self, $allowMockingProtectedMethods) {
    ...
    public function shouldNotReceive(...$methodNames)
    {
        ...
        $expectation = call_user_func_array(array(
            $this,
            'shouldReceive'
        ), $methodNames);
        $expectation->never();
    ...
    public function mockery_verify()
    {
        ...
        if (isset($this->_mockery_ignoreVerification) && $this->_mockery_ignoreVerification == true) {
            return;
        }
    ...
    public function mockery_validateOrder($method, $order)
    {
        if ($order < $this->_mockery_currentOrder) {
            $exception = new \Mockery\Exception\InvalidOrderException('Method ' . __CLASS__ . '::' . $method . '()' . ' called out of order: expected order ' . $order . ', was ' . $this->_mockery_currentOrder);
    ...
    /**
     * Calls a parent class method and returns the result.
     * Used in a passthru
    ...
    {
    /**
     * This does not add __wakeup method support.
     * It's a blind method and any
    ...
    protected static function _mockery_handleStaticMethodCall($method, array $args)
    {
        ...
        try {
            ...
            throw new BadMethodCallException('Static method ' . $associatedRealObject->mockery_getName() . '::' . $method . '() does not exist on this mock object', null, $e);
        }
    }
