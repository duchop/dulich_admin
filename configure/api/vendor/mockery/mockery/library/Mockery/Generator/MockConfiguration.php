...
class MockConfiguration
{
    ...
    public function __construct(array $targets = array(), array $blackListedMethods = array(), array $whiteListedMethods = array(), $name = null, $instanceMock = false, array $parameterOverrides = array(), $mockOriginalDestructor = false, array $constantsMap = array())
    {
     ...
     * filters them appropriately.
     * Lot's of filtering going on, perhaps we could
    ...
    public function getMethodsToMock()
    {
         ...
         * they implement Serializable, unserialize will have to be called.
         * As
         * such, we can't mock it and will need a pass to add a dummy
         * implementation
         */
        if ($this->getTargetClass() && $this->getTargetClass()->implementsInterface("Serializable") && $this->getTargetClass()->hasInternalAncestor()) {
    ...
    public function rename($className)
    {
        ...
        return new self($targets, $this->blackListedMethods, $this->whiteListedMethods, $className, $this->instanceMock, $this->parameterOverrides, $this->mockOriginalDestructor, $this->constantsMap);
    }
