...
class VerificationDirector
{
    ...
    {
        return $this->cloneApplyAndVerify("withArgs", array(
            $args
        ));
    }
    ...
    {
        return $this->cloneWithoutCountValidatorsApplyAndVerify("times", array(
            $limit
        ));
    }
    ...
    {
        return $this->cloneWithoutCountValidatorsApplyAndVerify("between", array(
            $minimum,
            $maximum
        ));
    }
