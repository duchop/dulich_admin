...
class XdgTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetHomeDir()
    {
        ...
        $this->assertEquals('/fake-dir', $this->getXdg()
            ->getHomeDir());
    }
    ...
    public function testGetFallbackHomeDir()
    {
        ...
        $this->assertEquals('C:/fake-dir', $this->getXdg()
            ->getHomeDir());
    }
    ...
    public function testXdgPutCache()
    {
        ...
        $this->assertEquals('tmp/', $this->getXdg()
            ->getHomeCacheDir());
    }
    ...
    public function testXdgDataDirsShouldIncludeHomeDataDir()
    {
        ...
        $this->assertArrayHasKey('tmp/', array_flip($this->getXdg()
            ->getDataDirs()));
    }
