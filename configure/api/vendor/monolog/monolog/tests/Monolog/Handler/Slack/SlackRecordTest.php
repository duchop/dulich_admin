...
class SlackRecordTest extends TestCase
{
    ...
    public function testAddsShortAttachmentWithoutContextAndExtra()
    {
        ...
        $data = $record->getSlackData($this->getRecord($level, 'test', array(
            'test' => 1
        )));
    ...
    public function testExcludeExtraAndContextFields()
    {
        ...
        $slackRecord = new SlackRecord(null, null, true, null, false, true, array(
        ...
        $expected = array(
            array(
                'title' => 'info',
                'value' => sprintf('```%s```', json_encode(array(
                    'author' => 'Jordi'
