        ...
        while (false !== $encodingDir = readdir($sampleFp)) {
            ...
            if (is_dir($sampleDir)) {
                ...
                while (false !== $sampleFile = readdir($fileFp)) {
                    ...
                    $this->assertEquals($encodedText, $text, '%s: Encoded string should be identical to original string for sample ' . $sampleDir . '/' . $sampleFile);
                }
                closedir($fileFp);
            }
        }
        ...
        while (false !== $encodingDir = readdir($sampleFp)) {
            ...
            if (is_dir($sampleDir)) {
                ...
                while (false !== $sampleFile = readdir($fileFp)) {
                    ...
                    $this->assertEquals($encoded, $text, '%s: Encoded string should be identical to original string for sample ' . $sampleDir . '/' . $sampleFile);
                }
                closedir($fileFp);
            }
        }
