...
class Swift_KeyCache_DiskKeyCacheAcceptanceTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->cache->setString($this->key1, 'foo', 'test', Swift_KeyCache::MODE_WRITE);
    ...
    {
        $this->cache->setString($this->key1, 'foo', 'test', Swift_KeyCache::MODE_WRITE);
        $this->cache->setString($this->key1, 'foo', 'whatever', Swift_KeyCache::MODE_WRITE);
    ...
    {
        $this->cache->setString($this->key1, 'foo', 'test', Swift_KeyCache::MODE_WRITE);
        $this->cache->setString($this->key1, 'foo', 'ing', Swift_KeyCache::MODE_APPEND);
    ...
    {
        $this->cache->setString($this->key1, 'foo', 'test', Swift_KeyCache::MODE_WRITE);
        $this->cache->setString($this->key2, 'foo', 'ing', Swift_KeyCache::MODE_WRITE);
        $this->assertEquals('test', $this->cache->getString($this->key1, 'foo'));
    ...
    {
        $this->cache->setString($this->key1, 'foo', 'test', Swift_KeyCache::MODE_WRITE);
        $this->cache->setString($this->key1, 'bar', 'ing', Swift_KeyCache::MODE_WRITE);
        $this->assertEquals('test', $this->cache->getString($this->key1, 'foo'));
    ...
    public function testByteStreamCanBeImported()
    {
        ...
        $this->cache->importFromByteStream($this->key1, 'foo', $os, Swift_KeyCache::MODE_WRITE);
    ...
    public function testByteStreamCanBeAppended()
    {
        ...
        $this->cache->importFromByteStream($this->key1, 'foo', $os1, Swift_KeyCache::MODE_APPEND);
        $this->cache->importFromByteStream($this->key1, 'foo', $os2, Swift_KeyCache::MODE_APPEND);
    ...
    {
        $this->cache->setString($this->key1, 'foo', 'test', Swift_KeyCache::MODE_APPEND);
        
        $os = new Swift_ByteStream_ArrayByteStream();
        $os->write('abcdef');
        
        $this->cache->importFromByteStream($this->key1, 'foo', $os, Swift_KeyCache::MODE_APPEND);
    ...
    {
        $this->cache->setString($this->key1, 'foo', 'test', Swift_KeyCache::MODE_WRITE);
        $this->cache->setString($this->key1, 'bar', 'xyz', Swift_KeyCache::MODE_WRITE);
        $this->assertTrue($this->cache->hasKey($this->key1, 'foo'));
