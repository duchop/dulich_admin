...
class Swift_Mime_MimePartAcceptanceTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->contentEncoder = new Swift_Mime_ContentEncoder_QpContentEncoder(new Swift_CharacterStream_ArrayCharacterStream($factory, 'utf-8'), new Swift_StreamFilters_ByteArrayReplacementFilter([
            [
                0x0D,
                0x0A
            ],
        ...
        $this->headers = new Swift_Mime_SimpleHeaderSet(new Swift_Mime_SimpleHeaderFactory($headerEncoder, $paramEncoder, $this->emailValidator));
    }
    ...
    public function testFormatIsSetInHeaders()
    {
        ...
        $part->setBody('> foobar');
        $this->assertEquals('Content-Type: text/plain; format=flowed' . "\r\n" . 'Content-Transfer-Encoding: quoted-printable' . "\r\n" . "\r\n" . '> foobar', $part->toString());
    }
    ...
    public function testDelSpIsSetInHeaders()
    {
        ...
        $part->setDelSp(true);
        $part->setBody('foobar');
        $this->assertEquals('Content-Type: text/plain; delsp=yes' . "\r\n" . 'Content-Transfer-Encoding: quoted-printable' . "\r\n" . "\r\n" . 'foobar', $part->toString());
    }
    ...
    public function testAll3ParamsInHeaders()
    {
        ...
        $part->setDelSp(true);
        $part->setBody('foobar');
        $this->assertEquals('Content-Type: text/plain; charset=utf-8; format=fixed; delsp=yes' . "\r\n" . 'Content-Transfer-Encoding: quoted-printable' . "\r\n" . "\r\n" . 'foobar', $part->toString());
    }
    ...
    {
        $entity = new Swift_Mime_MimePart($this->headers, $this->contentEncoder, $this->cache, $this->idGenerator);
