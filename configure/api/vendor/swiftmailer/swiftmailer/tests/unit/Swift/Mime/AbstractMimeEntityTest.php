...
abstract class Swift_Mime_AbstractMimeEntityTest extends \SwiftMailerTestCase
{
    ...
    public function testGetHeadersReturnsHeaderSet()
    {
        ...
        $entity = $this->createEntity($headers, $this->createEncoder(), $this->createCache());
    ...
    public function testGetEncoderFromConstructor()
    {
        ...
        $entity = $this->createEntity($this->createHeaderSet(), $encoder, $this->createCache());
    ...
    {
        $encoder = $this->createEncoder('base64');
        $encoding = $this->createHeader('Content-Transfer-Encoding', '8bit', [], false);
        $headers = $this->createHeaderSet([
    ...
    {
        $entity = $this->createEntity($this->createHeaderSet(), $this->createEncoder(), $this->createCache());
    ...
    public function testDescriptionIsSetInHeader()
    {
        ...
        $desc->shouldReceive('setFieldBodyModel')
            ->once()
            ->with('whatever');
    ...
    public function testBoundaryCanBeRetrieved()
    {
         ...
         */
        $entity = $this->createEntity($this->createHeaderSet(), $this->createEncoder(), $this->createCache());
        $this->assertRegExp('/^[a-zA-Z0-9\'\(\)\+_\-,\.\/:=\?\ ]{0,69}[a-zA-Z0-9\'\(\)\+_\-,\.\/:=\?]$/D', $entity->getBoundary());
    }
    ...
    {
        for ($level = Swift_Mime_SimpleMimeEntity::LEVEL_MIXED; $level > Swift_Mime_SimpleMimeEntity::LEVEL_TOP; $level /= 2) {
    ...
    {
        for ($level = Swift_Mime_SimpleMimeEntity::LEVEL_ALTERNATIVE; $level > Swift_Mime_SimpleMimeEntity::LEVEL_MIXED; $level /= 2) {
            $child = $this->createChild($level);
            $cType = $this->createHeader('Content-Type', 'text/plain', [], false);
            $cType->shouldReceive('setFieldBodyModel')
                ->once()
    ...
    {
        for ($level = Swift_Mime_SimpleMimeEntity::LEVEL_RELATED; $level > Swift_Mime_SimpleMimeEntity::LEVEL_ALTERNATIVE; $level /= 2) {
            $child = $this->createChild($level);
            $cType = $this->createHeader('Content-Type', 'text/plain', [], false);
            $cType->shouldReceive('setFieldBodyModel')
                ->once()
    ...
    public function testHighestLevelChildDeterminesContentType()
    {
        ...
        foreach ($combinations as $combination) {
            ...
            $entity = $this->createEntity($headerSet, $this->createEncoder(), $this->createCache());
    ...
    public function testChildrenAppearNestedInString()
    {
        ...
        $child1 = new MimeEntityFixture(Swift_Mime_SimpleMimeEntity::LEVEL_ALTERNATIVE, "Content-Type: text/plain\r\n" . "\r\n" . 'foobar', 'text/plain');
        
        $child2 = new MimeEntityFixture(Swift_Mime_SimpleMimeEntity::LEVEL_ALTERNATIVE, "Content-Type: text/html\r\n" . "\r\n" . '<b>foobar</b>', 'text/html');
        ...
        $this->assertEquals("Content-Type: multipart/alternative; boundary=\"xxx\"\r\n" . "\r\n" . "\r\n--xxx\r\n" . "Content-Type: text/plain\r\n" . "\r\n" . "foobar\r\n" . "\r\n--xxx\r\n" . "Content-Type: text/html\r\n" . "\r\n" . "<b>foobar</b>\r\n" . "\r\n--xxx--\r\n", $entity->toString());
    }
    ...
    public function testMixingLevelsIsHierarchical()
    {
        ...
        $part = $this->createChild(Swift_Mime_SimpleMimeEntity::LEVEL_ALTERNATIVE, "Content-Type: text/plain\r\n" . "\r\n" . 'foobar');
        
        $attachment = $this->createChild(Swift_Mime_SimpleMimeEntity::LEVEL_MIXED, "Content-Type: application/octet-stream\r\n" . "\r\n" . 'data');
        ...
        $this->assertRegExp('~^' . "Content-Type: multipart/mixed; boundary=\"xxx\"\r\n" . "\r\n\r\n--xxx\r\n" . "Content-Type: multipart/alternative; boundary=\"yyy\"\r\n" . "\r\n\r\n--(.*?)\r\n" . "Content-Type: text/plain\r\n" . "\r\n" . 'foobar' . "\r\n\r\n--\\1--\r\n" . "\r\n\r\n--xxx\r\n" . "Content-Type: application/octet-stream\r\n" . "\r\n" . 'data' . "\r\n\r\n--xxx--\r\n" . '$~', $entity->toString());
    }
    ...
    {
        $htmlChild = new MimeEntityFixture(Swift_Mime_SimpleMimeEntity::LEVEL_ALTERNATIVE, "Content-Type: text/html\r\n" . "\r\n" . 'HTML PART', 'text/html');
        $textChild = new MimeEntityFixture(Swift_Mime_SimpleMimeEntity::LEVEL_ALTERNATIVE, "Content-Type: text/plain\r\n" . "\r\n" . 'TEXT PART', 'text/plain');
        $headers = $this->createHeaderSet([], false);
        $headers->shouldReceive('toString')
            ->zeroOrMoreTimes()
            ->andReturn("Content-Type: multipart/alternative; boundary=\"xxx\"\r\n");
    ...
    {
        $firstChild = new MimeEntityFixture(Swift_Mime_SimpleMimeEntity::LEVEL_ALTERNATIVE, "Content-Type: text/plain\r\n" . "\r\n" . 'PART 1', 'text/plain');
        $secondChild = new MimeEntityFixture(Swift_Mime_SimpleMimeEntity::LEVEL_ALTERNATIVE, "Content-Type: text/plain\r\n" . "\r\n" . 'PART 2', 'text/plain');
        $headers = $this->createHeaderSet([], false);
        $headers->shouldReceive('toString')
            ->zeroOrMoreTimes()
            ->andReturn("Content-Type: multipart/alternative; boundary=\"xxx\"\r\n");
    ...
    public function testBodyIsReadFromCacheWhenUsingToByteStreamIfPresent()
    {
        ...
        $entity = $this->createEntity($this->createHeaderSet(), $this->createEncoder(), $cache);
        $entity->setBody('foo');
    ...
    public function testFluidInterface()
    {
        ...
        $this->assertSame($entity, $entity->setContentType('text/plain')
