...
class Swift_Mime_ContentEncoder_Base64ContentEncoderTest extends \SwiftMailerTestCase
{
    ...
    public function testPadLength()
    {
        ...
        for ($i = 0; $i < 30; ++ $i) {
            ...
            $this->encoder->encodeByteStream($os, $is);
            $this->assertRegExp('~^[a-zA-Z0-9/\+]{2}==$~', $collection->content, '%s: A single byte should have 2 bytes of padding');
        }
        ...
        for ($i = 0; $i < 30; ++ $i) {
            ...
            $this->encoder->encodeByteStream($os, $is);
            $this->assertRegExp('~^[a-zA-Z0-9/\+]{3}=$~', $collection->content, '%s: Two bytes should have 1 byte of padding');
        }
        ...
        for ($i = 0; $i < 30; ++ $i) {
            ...
            $this->encoder->encodeByteStream($os, $is);
            $this->assertRegExp('~^[a-zA-Z0-9/\+]{4}$~', $collection->content, '%s: Three bytes should have no padding');
        }
    }
    ...
    public function testMaximumLineLengthIs76Characters()
    {
        ...
        $this->encoder->encodeByteStream($os, $is);
        $this->assertEquals("YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXphYmMxMjM0NTY3ODkwQUJDREVGR0hJSktMTU5PUFFS\r\n" . 'U1RVVldYWVoxMjM0NTY3YWJjZGVmZ2hpamts', $collection->content);
    }
    ...
    public function testMaximumLineLengthCanBeDifferent()
    {
        ...
        $this->assertEquals("YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXphYmMxMjM0NTY3OD\r\n" . "kwQUJDREVGR0hJSktMTU5PUFFSU1RVVldYWVoxMjM0NTY3YWJj\r\n" . 'ZGVmZ2hpamts', $collection->content);
    }
    ...
    public function testFirstLineLengthCanBeDifferent()
    {
        ...
        $this->assertEquals("YWJjZGVmZ2hpamtsbW5vcHFyc3R1dnd4eXphYmMxMjM0NTY3ODkwQUJDR\r\n" . 'EVGR0hJSktMTU5PUFFSU1RVVldYWVoxMjM0NTY3YWJjZGVmZ2hpamts', $collection->content);
    }
