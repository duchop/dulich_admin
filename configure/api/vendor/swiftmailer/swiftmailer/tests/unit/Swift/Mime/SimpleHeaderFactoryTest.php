...
class Swift_Mime_SimpleHeaderFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        return new Swift_Mime_SimpleHeaderFactory($encoder ? $encoder : $this->createHeaderEncoder(), $paramEncoder ? $paramEncoder : $this->createParamEncoder(), new EmailValidator());
    }
