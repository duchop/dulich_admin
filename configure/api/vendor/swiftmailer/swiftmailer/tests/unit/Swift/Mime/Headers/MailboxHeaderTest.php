...
class Swift_Mime_Headers_MailboxHeaderTest extends \SwiftMailerTestCase
{
    ...
    public function testNameIsEncodedIfNonAscii()
    {
        ...
        $this->assertEquals('Chris =?' . $this->charset . '?Q?C=8Frbyn?= <chris@swiftmailer.org>', array_shift($addresses));
    }
    ...
    public function testGetValueReturnsMailboxStringValue()
    {
        ...
        $this->assertEquals('Chris Corbyn <chris@swiftmailer.org>', $header->getFieldBody());
    }
    ...
    public function testGetValueReturnsMailboxStringValueForMultipleMailboxes()
    {
        ...
        $this->assertEquals('Chris Corbyn <chris@swiftmailer.org>, Mark Corbyn <mark@swiftmailer.org>', $header->getFieldBody());
    }
    ...
    public function testToString()
    {
        ...
        $this->assertEquals('From: Chris Corbyn <chris@swiftmailer.org>, ' . 'Mark Corbyn <mark@swiftmailer.org>' . "\r\n", $header->toString());
    }
