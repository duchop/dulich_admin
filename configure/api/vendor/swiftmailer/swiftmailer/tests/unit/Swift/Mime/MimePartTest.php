...
class Swift_Mime_MimePartTest extends Swift_Mime_AbstractMimeEntityTest
{
    ...
    {
        $part = $this->createMimePart($this->createHeaderSet(), $this->createEncoder(), $this->createCache());
        $this->assertEquals(Swift_Mime_SimpleMimeEntity::LEVEL_ALTERNATIVE, $part->getNestingLevel());
    }
    ...
    public function testSettingCharsetNotifiesEncoder()
    {
        ...
        $part = $this->createMimePart($this->createHeaderSet(), $encoder, $this->createCache());
        $part->setCharset('utf-8');
    }
    ...
    public function testSettingCharsetNotifiesHeaders()
    {
        ...
        $part = $this->createMimePart($headers, $this->createEncoder(), $this->createCache());
        $part->setCharset('utf-8');
    }
    ...
    public function testFluidInterface()
    {
        ...
        $this->assertSame($part, $part->setContentType('text/plain')
