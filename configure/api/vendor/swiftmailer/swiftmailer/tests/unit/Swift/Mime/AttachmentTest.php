...
class Swift_Mime_AttachmentTest extends Swift_Mime_AbstractMimeEntityTest
{
    ...
    {
        $attachment = $this->createAttachment($this->createHeaderSet(), $this->createEncoder(), $this->createCache());
        $this->assertEquals(Swift_Mime_SimpleMimeEntity::LEVEL_MIXED, $attachment->getNestingLevel());
    }
    ...
    public function testDispositionIsAddedIfNonePresent()
    {
        ...
        $attachment = $this->createAttachment($headers, $this->createEncoder(), $this->createCache());
        $attachment->setDisposition('inline');
    }
    ...
    {
        $attachment = $this->createAttachment($this->createHeaderSet(), $this->createEncoder(), $this->createCache());
        $this->assertSame($attachment, $attachment->setContentType('application/pdf')
