...
class Swift_Mime_SimpleMessageTest extends Swift_Mime_MimePartTest
{
    ...
    {
        $message = $this->createMessage($this->createHeaderSet(), $this->createEncoder(), $this->createCache());
    ...
    public function testDateHeaderIsCreatedIfNonePresent()
    {
        ...
        $message = $this->createMessage($headers, $this->createEncoder(), $this->createCache());
        $message->setDate($dateTime);
    }
    ...
    public function testSenderIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.2.
         */
        $sender = $this->createHeader('Sender', [
            'sender@domain' => 'Name'
        ]);
        $message = $this->createMessage($this->createHeaderSet([
            'Sender' => $sender
    ...
    public function testReplyToIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.2.
         */
        $reply = $this->createHeader('Reply-To', [
            'reply@domain' => 'Name'
        ]);
        $message = $this->createMessage($this->createHeaderSet([
            'Reply-To' => $reply
    ...
    {
        $replyTo = $this->createHeader('Reply-To', [
            'from@domain' => 'Name'
        ], [], false);
    ...
    public function testReadReceiptAddressReadFromHeader()
    {
        ...
        $message = $this->createMessage($this->createHeaderSet([
            'Disposition-Notification-To' => $rcpt
        ]), $this->createEncoder(), $this->createCache());
        $this->assertEquals([
            'chris@swiftmailer.org' => 'Chris'
    ...
    {
        $child = $this->createChild(Swift_Mime_SimpleMimeEntity::LEVEL_RELATED, '', false);
    ...
    public function testFluidInterface()
    {
        $child = $this->createChild();
        $message = $this->createMessage($this->createHeaderSet(), $this->createEncoder(), $this->createCache());
        $this->assertSame($message, $message->setContentType('text/plain')
