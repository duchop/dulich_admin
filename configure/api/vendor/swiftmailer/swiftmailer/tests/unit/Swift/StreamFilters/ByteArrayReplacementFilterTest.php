...
class Swift_StreamFilters_ByteArrayReplacementFilterTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testShouldBufferReturnsTrueIfPartialMatchAtEndOfBuffer()
    {
        ...
        $this->assertTrue($filter->shouldBuffer([
            0x59,
            0x60,
            0x61
        ]), '%s: Filter should buffer since 0x61 0x62 is the needle and the ending ' . '0x61 could be from 0x61 0x62');
    }
    ...
    public function testShouldBufferReturnsTrueIfAnyOfMultipleMatchesAtEndOfString()
    {
        ...
        $this->assertTrue($filter->shouldBuffer([
            ...
            0x60,
            0x61
        ]), '%s: Filter should buffer since 0x61 0x62 is a needle and the ending ' . '0x61 could be from 0x61 0x62');
    }
