...
class Swift_Mime_Headers_DateHeaderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testDateTimeIsConvertedToImmutable()
    {
        ...
        $this->assertEquals($dateTime->getTimestamp(), $header->getDateTime()
            ->getTimestamp());
        $this->assertEquals($dateTime->getTimezone(), $header->getDateTime()
            ->getTimezone());
    }
    ...
    public function testDateTimeIsImmutable()
    {
        ...
        $this->assertEquals('Sat, 01 Jan 2000 12:00:00 +0100', $header->getDateTime()
            ->format('r'));
