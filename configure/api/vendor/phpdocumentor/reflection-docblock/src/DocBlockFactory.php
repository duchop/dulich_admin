...
final class DocBlockFactory implements DocBlockFactoryInterface
{
     ...
     *            A string containing the DocBlock to parse or an object supporting the
    ...
    public function create($docblock, Types\Context $context = null, Location $location = null)
    {
        ...
        return new DocBlock($summary, $description ? $this->descriptionFactory->create($description, $context) : null, array_filter($this->parseTagBlock($tags, $context), function ($tag) {
