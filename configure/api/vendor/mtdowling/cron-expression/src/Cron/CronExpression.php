...
class CronExpression
{
     ...
     * @param int $nth
     *            Number of matches to skip before returning a
     ...
     *            Set to TRUE to return the current date if
     ...
     *
     * @param string $part
     *            Specify the part to retrieve or NULL to get the full
     ...
     * specific date.
     * This method assumes that the current number of
