...
class CronExpressionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testStripsForSeconds()
    {
        ...
        $this->assertEquals('2011-09-27 10:11:00', $cron->getNextRunDate($current)
            ->format('Y-m-d H:i:s'));
    }
    ...
    public function testFixesPhpBugInDateIntervalMonth()
    {
        ...
        $this->assertEquals('2011-01-27 00:00:00', $cron->getPreviousRunDate('2011-08-22 00:00:00')
            ->format('Y-m-d H:i:s'));
    }
    ...
    {
        $cron = CronExpression::factory('@weekly');
        $this->assertEquals('2013-03-10 00:00:00', $cron->getPreviousRunDate('2013-03-17 00:00:00')
            ->format('Y-m-d H:i:s'));
    }
