...
class ShellTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testScopeVariables()
    {
        ...
        $diff = $shell->getScopeVariablesDiff([
            'one' => $one,
            'two' => 'not two'
        ]);
        $this->assertSame([
    ...
    public function getReturnValues()
    {
        return [
            [
                '{{return value}}',
                "=> \"\033[32m{{return value}}\033[39m\"" . PHP_EOL
            ],
            [
                1,
                "=> \033[35m1\033[39m" . PHP_EOL
            ]
        ];
    }
    ...
    public function getRenderedExceptions()
    {
        return [
            [
                ...
                "Exception with message '{{message}}'" . PHP_EOL
            ]
        ];
    }
    ...
    public function testHasCommand($command, $has)
    {
        ...
        $this->assertEquals($method->invokeArgs($shell, [
            $command
        ]), $has);
    }
