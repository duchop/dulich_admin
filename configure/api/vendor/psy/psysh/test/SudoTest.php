...
class SudoTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCallMethod()
    {
        ...
        $this->assertSame('private and method with ["foo",2]', Sudo::callMethod($obj, 'privateMethod', [
            'foo',
            2
        ]));
    }
    ...
    public function testCallStatic()
    {
        ...
        $this->assertSame('private and static and method with ["foo",2]', Sudo::callStatic($obj, 'privateStaticMethod', [
            'foo',
            2
        ]));
    }
