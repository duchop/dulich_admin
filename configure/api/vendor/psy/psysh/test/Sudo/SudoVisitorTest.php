...
class SudoVisitorTest extends ParserTestCase
{
    ...
    public function staticPropertyFetches()
    {
        return [
            [
                'A::$b',
                "\Psy\Sudo::fetchStaticProperty('A', 'b');"
            ],
            [
                '$a::$b',
                "\Psy\Sudo::fetchStaticProperty(\$a, 'b');"
    ...
    public function staticPropertyAssigns()
    {
        return [
            [
                'A::$b = $c',
                "\Psy\Sudo::assignStaticProperty('A', 'b', \$c);"
            ],
            [
                '$a::$b = $c',
                "\Psy\Sudo::assignStaticProperty(\$a, 'b', \$c);"
