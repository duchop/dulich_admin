...
EOS;
        ...
        return [
            [
                new \ReflectionClass('Psy\Test\Formatter\Fixtures\SomeClass'),
                $expectClass
            ],
            [
            ...
            [
                new \ReflectionMethod('Psy\Test\Formatter\Fixtures\SomeClass', 'someMethod'),
                $expectMethod
            ],
            [
                new \ReflectionFunction(SomeClass::someClosure()),
                $expectClosure
            ]
        ];
    }
    ...
    public function invalidReflectors()
    {
        $reflectors = [
            ...
            [
                new \ReflectionParameter([
                    'Psy\Test\Formatter\Fixtures\SomeClass',
                    'someMethod'
                ], 'someParam')
            ],
            [
        ...
        if (\version_compare(PHP_VERSION, '7.1.0', '>=')) {
            $reflectors[] = [
                new \ReflectionClassConstant('Psy\Test\Formatter\Fixtures\SomeClass', 'SOME_CONST')
            ];
        }
