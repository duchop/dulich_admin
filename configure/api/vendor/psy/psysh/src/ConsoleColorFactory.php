...
class ConsoleColorFactory
{
    ...
    private function getDefaultConsoleColor()
    {
        ...
        $color->addTheme(Highlighter::LINE_NUMBER, [
            'blue'
        ]);
        $color->addTheme(Highlighter::TOKEN_KEYWORD, [
            'yellow'
        ]);
        $color->addTheme(Highlighter::TOKEN_STRING, [
            'green'
        ]);
        $color->addTheme(Highlighter::TOKEN_COMMENT, [
            'dark_gray'
        ]);
    ...
    private function getDisabledConsoleColor()
    {
        ...
        $color->addTheme(Highlighter::TOKEN_DEFAULT, [
            'none'
        ]);
        $color->addTheme(Highlighter::TOKEN_HTML, [
            'none'
        ]);
        $color->addTheme(Highlighter::ACTUAL_LINE_MARK, [
            'none'
        ]);
        $color->addTheme(Highlighter::LINE_NUMBER, [
            'none'
