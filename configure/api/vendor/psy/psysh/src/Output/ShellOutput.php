...
class ShellOutput extends ConsoleOutput
{
     ...
     *            (default: null)
     * @param null|string|OutputPager $pager
     *            (default: null)
     */
    ...
    private function initFormatters()
    {
        ...
        $formatter->setStyle('strong', new OutputFormatterStyle(null, null, [
            'bold'
        ]));
        ...
        // Visibility
        $formatter->setStyle('public', new OutputFormatterStyle(null, null, [
            'bold'
        ]));
        $formatter->setStyle('protected', new OutputFormatterStyle('yellow'));
        $formatter->setStyle('private', new OutputFormatterStyle('red'));
        $formatter->setStyle('global', new OutputFormatterStyle('cyan', null, [
            'bold'
        ]));
        $formatter->setStyle('const', new OutputFormatterStyle('cyan'));
        $formatter->setStyle('class', new OutputFormatterStyle('blue', null, [
            'underscore'
        ]));
