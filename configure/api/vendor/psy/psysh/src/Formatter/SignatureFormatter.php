...
class SignatureFormatter implements Formatter
{
    ...
    private static function formatConstant($reflector)
    {
        ...
        return \sprintf('<keyword>define</keyword>(<string>%s</string>, <%s>%s</%s>)', OutputFormatter::escape(Json::encode($reflector->getName())), $style, OutputFormatter::escape(Json::encode($value)), $style);
    }
