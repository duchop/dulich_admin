...
class RunkitReloader extends AbstractListener
{
    ...
    private function reload(Shell $shell)
    {
        ...
        foreach ($modified as $file) {
            runkit_import($file, (RUNKIT_IMPORT_FUNCTIONS | RUNKIT_IMPORT_CLASSES | RUNKIT_IMPORT_CLASS_METHODS | RUNKIT_IMPORT_CLASS_CONSTS | RUNKIT_IMPORT_CLASS_PROPS | RUNKIT_IMPORT_OVERRIDE));
        }
    }
