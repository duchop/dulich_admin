...
class PassableByReferencePass extends CodeCleanerPass
{
    ...
    private function isPassableByReference(Node $arg)
    {
        ...
        return $arg->value instanceof ClassConstFetch || $arg->value instanceof PropertyFetch || $arg->value instanceof Variable || $arg->value instanceof FuncCall || $arg->value instanceof MethodCall || $arg->value instanceof StaticCall;
    }
