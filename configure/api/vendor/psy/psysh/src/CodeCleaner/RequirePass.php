...
class RequirePass extends CodeCleanerPass
{
    ...
    public function enterNode(Node $origNode)
    {
         ...
         */
        $node->expr = new StaticCall(new FullyQualifiedName('Psy\CodeCleaner\RequirePass'), 'resolve', [
            new Arg($origNode->expr),
            new Arg(new LNumber($origNode->getLine()))
