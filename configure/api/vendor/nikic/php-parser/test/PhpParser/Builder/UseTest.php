...
class UseTest extends TestCase
{
    ...
    public function testCreation()
    {
        ...
        $node = $this->createUseBuilder(new Name('Foo\Bar'))
            ->as('XYZ')
            ->getNode();
        $this->assertEquals(new Stmt\Use_([
        ...
        $node = $this->createUseBuilder('foo\bar', Stmt\Use_::TYPE_FUNCTION)
            ->as('foo')
            ->getNode();
        $this->assertEquals(new Stmt\Use_([
        ...
        $node = $this->createUseBuilder('foo\BAR', Stmt\Use_::TYPE_CONSTANT)
            ->as('FOO')
            ->getNode();
        $this->assertEquals(new Stmt\Use_([
            new Stmt\UseUse(new Name('foo\BAR'), 'FOO')
