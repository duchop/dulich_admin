...
class ParamTest extends TestCase
{
    ...
    public function provideTestDefaultValues()
    {
        return [
            ...
            [
                ...
                new Expr\Array_([
                    new Expr\ArrayItem(new Scalar\String_('bar'), new Scalar\String_('foo')),
                    new Expr\ArrayItem(new Scalar\String_('foo'), new Scalar\String_('bar'))
                ])
            ],
            [
    ...
    public function provideTestTypes()
    {
        return [
            ...
            [
                'iterable',
                new Node\Identifier('iterable')
            ],
            [
                'object',
                new Node\Identifier('object')
            ],
            [
                'Array',
                new Node\Identifier('array')
            ...
            [
                '?array',
                new Node\NullableType(new Node\Identifier('array'))
            ],
            [
                '?Some\Class',
    ...
    public function testByRef()
    {
        ...
        $this->assertEquals(new Node\Param(new Expr\Variable('test'), null, null, true), $node);
    }
    ...
    public function testVariadic()
    {
        ...
        $this->assertEquals(new Node\Param(new Expr\Variable('test'), null, null, false, true), $node);
    }
}
