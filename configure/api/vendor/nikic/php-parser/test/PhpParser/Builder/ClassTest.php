...
DOC;
    ...
    {
        $this->createClassBuilder('Test')->addStmt(new Stmt\Echo_([]));
    }
    ...
    {
        $this->createClassBuilder('Test')->setDocComment(new Comment('Test'));
    }
