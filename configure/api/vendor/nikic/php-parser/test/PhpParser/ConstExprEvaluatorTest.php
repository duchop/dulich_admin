...
class ConstExprEvaluatorTest extends TestCase
{
    ...
    public function testEvaluateFallback()
    {
        ...
        $expr = new Expr\BinaryOp\Plus(new Scalar\LNumber(8), new Scalar\MagicConst\Line());
    ...
    public function testEvaluateSilently($expr, $exception, $msg)
    {
        ...
        try {
            ...
            $this->assertSame('An error occurred during constant expression evaluation', $e->getMessage());
