...
class LexerTest extends TestCase
{
    ...
    public function provideTestError()
    {
        return [
            ...
            [
                "<?php \1",
                [
                    "Unexpected character \"\1\" (ASCII 1) from 1:7 to 1:7"
                ]
            ],
            [
                "<?php \0",
                [
                    "Unexpected null byte from 1:7 to 1:7"
                ]
            ],
            ...
            [
                "<?php ?? \0",
                [
                    "Unexpected null byte from 1:10 to 1:10"
                ]
            ],
            [
                "<?php\n\0\1 foo /* bar",
    ...
    public function provideTestHaltCompiler()
    {
        return [
            [
                '<?php ... __halt_compiler();Remaining Text',
                'Remaining Text'
            ],
            [
                '<?php ... __halt_compiler ( ) ;Remaining Text',
