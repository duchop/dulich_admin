    ...
    public function provideTestExtraAttributes()
    {
        return [
            ...
            [
                '07',
                [
                    'kind' => Scalar\LNumber::KIND_OCT
                ]
            ],
            [
                '0xf',
                [
                    'kind' => Scalar\LNumber::KIND_HEX
                ]
            ],
            [
                '0XF',
            ...
            [
                "namespace Foo;",
                [
                    'kind' => Stmt\Namespace_::KIND_SEMICOLON
                ]
            ],
            [
                "namespace Foo {}",
