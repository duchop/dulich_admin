    ...
    public function provideTestParse()
    {
        return [
            ...
            [
                ...
                $this->getPrefer5(),
                [
                    new Stmt\Expression(new Expr\Variable(new Expr\ArrayDimFetch(new Expr\Variable('a'), LNumber::fromString('0'))))
                ]
            ],
            [
                ...
                $this->getPrefer7(),
                [
                    new Stmt\Expression(new Expr\ArrayDimFetch(new Expr\Variable(new Expr\Variable('a')), LNumber::fromString('0')))
                ]
            ]
        ];
    }
