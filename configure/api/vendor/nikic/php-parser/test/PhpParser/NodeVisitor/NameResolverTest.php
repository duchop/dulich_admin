...
EOC;
    ...
    {
        $stmts = [
            new Node\Expr\New_(new Name('self'))
        ];
    ...
    public function testAddDeclarationNamespacedName()
    {
        ...
        $stmts = $traverser->traverse([
            new Stmt\Namespace_(new Name('NS'), $nsStmts)
        ]);
        ...
        $stmts = $traverser->traverse([
            new Stmt\Namespace_(null, $nsStmts)
        ]);
    ...
    public function provideTestError()
    {
        return [
            [
                new Stmt\Use_([
                    new Stmt\UseUse(new Name('A\B'), 'B', 0, [
                        'startLine' => 1
                    ]),
                    new Stmt\UseUse(new Name('C\D'), 'B', 0, [
                        'startLine' => 2
                    ])
            ...
            [
                new Expr\New_(new Name\FullyQualified('self', [
                    'startLine' => 3
                ])),
                "'\\self' is an invalid class name on line 3"
            ],
            [
                new Expr\New_(new Name\Relative('self', [
                    'startLine' => 3
                ])),
                "'\\self' is an invalid class name on line 3"
            ],
            [
                new Expr\New_(new Name\FullyQualified('PARENT', [
                    'startLine' => 3
                ])),
                "'\\PARENT' is an invalid class name on line 3"
            ],
            [
                new Expr\New_(new Name\Relative('STATIC', [
                    'startLine' => 3
                ])),
...
EOC;
    ...
    public function testAttributeOnlyMode()
    {
        ...
        $this->assertEquals(new Name\FullyQualified('Foo\Bar'), $n1->getAttribute('resolvedName'));
        $this->assertFalse($n2->hasAttribute('resolvedName'));
        $this->assertEquals(new Name\FullyQualified('Foo\bar'), $n2->getAttribute('namespacedName'));
    }
}
