...
/**
 * This class defines helpers used in the implementation of builders.
...
final class BuilderHelpers
{
     ...
     * @param Expr|Name|string $name
     *            The name to normalize
     * @param bool $allowExpr
     *            Whether to also allow expressions
     *            
     ...
     *
     * @param string|Name|Identifier|NullableType $type
     ...
     *
     * @param Node\Expr|bool|null|int|float|string|array $value
