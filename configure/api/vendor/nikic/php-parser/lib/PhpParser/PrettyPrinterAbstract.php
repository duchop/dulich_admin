...
abstract class PrettyPrinterAbstract
{
 ...
 // Encapsed string part
     ...
     * @param null|string $insertStr
     *            Separator string to use for insertions
     *            
