...
class BuilderFactory
{
     ...
     *
     * @param null|string|Node\Name $name
     ...
     *
     * @param Node\Name|string|null $trait
     *            Trait name
     * @param Node\Identifier|string $method
     *            Method name
     *            
     ...
     *
     * @param Expr|bool|null|int|float|string|array $value
     *            $value
     *            
     * @return Expr
     */
