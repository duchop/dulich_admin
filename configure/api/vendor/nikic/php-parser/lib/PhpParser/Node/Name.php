...
class Name extends NodeAbstract
{
    ...
    /**
     * Gets the first part of the name, i.e.
     * everything before the first namespace separator.
     *
    ...
    /**
     * Gets the last part of the name, i.e.
     * everything after the last namespace separator.
     *
    ...
    /**
     * Checks whether the name is unqualified.
     * (E.g. Name)
     *
    ...
    /**
     * Checks whether the name is qualified.
     * (E.g. Name\Name)
     *
    ...
    /**
     * Checks whether the name is fully qualified.
     * (E.g. \Name)
     *
    ...
    /**
     * Checks whether the name is explicitly relative to the current namespace.
     * (E.g. namespace\Name)
     *
